...
const CACHE_NAME = "dfl-hq-v1.109.50";
const CDN_HOSTS = new Set(["cdn.jsdelivr.net","fonts.googleapis.com","fonts.gstatic.com"]);
const APP_SHELL = ["./","./index.html","./css/tokens.css","./css/style.css","./css/ui.css","./css/screens.css","./css/marquee.css","./css/stage.css","./css/broadcast.css","./css/golf.css","./css/splash-loading.css","./fonts/rajdhani-600.woff2","./fonts/rajdhani-700.woff2","./manifest.json","./js/config.js","./js/app.js","./js/install.js","./js/update.js","./js/arena-finish-line.js","./js/members.js","./js/member-lock.js","./js/presence.js","./js/theme.js","./js/router.js","./js/sportsbook-nav.js","./js/profile-commissioner.js","./js/store.js","./js/supabase.js","./js/focus-trap.js","./js/keeper-advisor.js","./js/keeper-rules.js","./js/keeper-entry.js","./js/keeper-self.js","./js/ui.js","./js/lore.js","./js/whatsnew.js","./js/broadcast-deck.js","./js/broadcast-stage.js","./js/marquee.js","./js/golf-guest.js","./js/golf-join.js","./js/crud.js","./js/form.js","./js/form-layout.js","./js/inline.js","./js/sections.js","./js/settings.js","./js/sleeper.js","./js/sync.js","./js/pages/home.js","./js/pages/rules.js","./js/pages/keepers.js","./js/pages/polls.js","./js/pages/arena.js","./js/pages/golf.js","./js/pages/sportsbook.js","./js/sportsbook-ticket.js","./js/pages/proposals.js","./js/chip-eaters.js","./js/activity.js","./js/sleeper-bracket.js","./js/name-pick.js","./js/season-result.js","./js/golf-scorecard.js","./js/golf-offline.js","./js/golf-battle.js","./js/golf-people.js","./js/share.js","./js/fact-share.js","./js/golf-share.js","./js/golf-match.js","./js/golf-matches.js","./js/collapse.js","./js/golf-courses.js","./js/golf-draft.js","./js/golf-bag.js","./js/pages/broadcast.js","./js/arena/race.js","./js/arena/racer-view.js","./js/arena/sprites.js","./js/arena/dfl-sprites.js","./js/pages/calendar.js","./js/pages/history.js","./js/pages/facts.js","./js/funfacts.js","./js/pages/finances.js","./js/pages/profile.js","./js/pages/profile-locked.js","./js/pages/profile-dfl.js","./js/pages/admin.js","./js/pages/admin_commissioners.js","./js/pages/admin_sleeper.js","./js/pages/admin_finance.js","./js/pages/admin_finance_setup.js","./js/pages/admin_broadcast.js","./icons/app-192.png","./icons/app-512.png","./icons/app-maskable-512.png","./icons/mark-192.png","./icons/mark-512.png","./icons/mark-maskable-512.png","./icons/crest-512.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/apple-touch-icon.png","./icons/logo-64.png","./icons/logo-crest.png","./icons/dfl-seal-512.png","./icons/dfl-seal-192.png","./js/ticker-lines.js","./js/broadcast-order.js"];
/*
  PRECACHE PER ITEM, NOT ALL-OR-NOTHING.

  cache.addAll() rejects the whole batch if ANY single request fails, and a
  rejected install means waitUntil rejects, skipWaiting() never runs, the
  worker never activates and every client stays on the PREVIOUS cache. One
  stale filename in a 99-entry list therefore takes the entire update
  mechanism down silently - which is exactly what happened when a root PNG was
  moved into assets/ and this list was not updated with it: the app shipped
  three releases' worth of JS that clients could not reliably get.

  Per-item add() with a caught failure keeps the shell as complete as the
  network allows and lets the worker install regardless. A genuinely missing
  file now costs one console warning and one cache miss, not the update path.
  The fetch handler is unchanged - still network-first, cache as fallback.
*/
