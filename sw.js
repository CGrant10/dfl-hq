...
const CACHE_NAME = "dfl-hq-v1.246.75";
...
const APP_SHELL = [
  "./","./index.html","./manifest.json","./css/power-pulse-system.css?v=1.246.75",
  ...
  "./js/performance.js","./js/pages/admin_performance.js","./js/pages/admin_operations.js","./js/breaking-trade.js","./js/league-state.js",
