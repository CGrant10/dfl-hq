...
function calmSetupMarkup(state) {
  ...
  return `<main class="tb-shell" data-tbeta-root>
    ...
    <section class="tb-setup">
      ...
      ${customSetup}${traditionalBuilder}${guestAccess}${traditionalRounds}<div class="tb-status" data-tb-status></div>
    </section>
  </main>`;
}
