...
const STORAGE_KEY="dfl.arenaBeta.loadout.v5";
const ART="assets/arena-beta/arena-beta-render.jpg?v=1.112.5";
...
let artImage=null;
function ensureAssets(){if(!document.getElementById("arena-beta-render-css")){const l=document.createElement("link");l.id="arena-beta-render-css";l.rel="stylesheet";l.href="css/arena-beta-render.css?v=1.112.5";document.head.appendChild(l)}}
...
function loadArtwork(root){const img=new Image();artImage=img;img.decoding="async";img.onload=()=>{root.dataset.artSize=`${img.naturalWidth}×${img.naturalHeight}`;drawAll(root)};img.onerror=()=>markArtError(root);img.src=ART}
