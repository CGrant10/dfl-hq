...
a.extension = r.TextureSource;
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/canvas/utils/canUseNewCanvasBlendModes.mjs
var o;
function s(e) {
	let t = i.get().createCanvas(6, 1), n = t.getContext("2d");
	return n.fillStyle = e, n.fillRect(0, 0, 6, 1), t;
}
function c() {
	if (o !== void 0) return o;
	try {
		let e = s("#ff00ff"), t = s("#ffff00"), n = i.get().createCanvas(6, 1).getContext("2d");
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/canvas/utils/canvasUtils.mjs
var l = {
	canvas: null,
	...
	getCanvasSource: (e) => {
		...
		if (!n) return null;
		let r = t.alphaMode === "premultiplied-alpha", a = t.resourceWidth ?? t.pixelWidth, o = t.resourceHeight ?? t.pixelHeight, s = a !== t.pixelWidth || o !== t.pixelHeight;
		if (r) {
			if ((n instanceof HTMLCanvasElement || typeof OffscreenCanvas < "u" && n instanceof OffscreenCanvas) && !s) return n;
		...
		if (n instanceof Uint8Array || n instanceof Uint8ClampedArray || n instanceof Int8Array || n instanceof Uint16Array || n instanceof Int16Array || n instanceof Uint32Array || n instanceof Int32Array || n instanceof Float32Array || n instanceof ArrayBuffer) {
			...
			if (e?.resourceId === t._resourceId) return e.canvas;
			let r = i.get().createCanvas(t.pixelWidth, t.pixelHeight), a = r.getContext("2d"), o = a.createImageData(t.pixelWidth, t.pixelHeight), s = o.data, c = n instanceof ArrayBuffer ? new Uint8Array(n) : new Uint8Array(n.buffer, n.byteOffset, n.byteLength);
		...
		if (r) {
			let e = i.get().createCanvas(t.pixelWidth, t.pixelHeight), r = e.getContext("2d", { willReadFrequently: !0 });
			e.width = t.pixelWidth, e.height = t.pixelHeight, r.drawImage(n, 0, 0);
			let a = r.getImageData(0, 0, e.width, e.height), o = a.data;
			...
			return r.putImageData(a, 0, 0), l._unpremultipliedCache.set(t, {
				canvas: e,
				resourceId: t._resourceId
			}), e;
		}
		if (s) {
			let e = l._canvasSourceCache.get(t);
			if (e?.resourceId === t._resourceId) return e.canvas;
			let r = i.get().createCanvas(t.pixelWidth, t.pixelHeight), a = r.getContext("2d");
			return r.width = t.pixelWidth, r.height = t.pixelHeight, a.drawImage(n, 0, 0), l._canvasSourceCache.set(t, {
				canvas: r,
				resourceId: t._resourceId
			}), r;
		}
