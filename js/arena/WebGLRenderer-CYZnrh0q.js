	...
	_initColor(e, t) {
		...
		if (t.resolveTargetFramebuffer = a, i.bindFramebuffer(i.FRAMEBUFFER, a), t.width = e.colorTexture.source.pixelWidth, t.height = e.colorTexture.source.pixelHeight, e.colorTextures.forEach((e, a) => {
			...
			if (s.target === i.TEXTURE_2D) i.framebufferTexture2D(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0 + a, i.TEXTURE_2D, c, 0);
				...
				if (r.context.webGLVersion < 2) throw Error("[RenderTargetSystem] TEXTURE_2D_ARRAY requires WebGL2.");
...
function He(e) {
	...
	if (t.normal = [e.ONE, e.ONE_MINUS_SRC_ALPHA], t.add = [e.ONE, e.ONE], t.multiply = [
		...
		e.ONE,
		e.ONE_MINUS_SRC_ALPHA
	], t.erase = [e.ZERO, e.ONE_MINUS_SRC_ALPHA], !(e instanceof h.get().getWebGLRenderingContext())) t.min = [
		e.ONE,
		e.ONE,
		e.ONE,
		e.ONE,
...
function lt(e, t, n, r, i, a, o, s) {
	...
	if (!s || e.addressModeU !== "repeat" || e.addressModeV !== "repeat" || e.addressModeW !== "repeat") {
		let n = Q[o ? "clamp-to-edge" : e.addressModeU], r = Q[o ? "clamp-to-edge" : e.addressModeV], a = Q[o ? "clamp-to-edge" : e.addressModeW];
...
function dt(e, t) {
	let n = {}, r = e.RGBA;
	return e instanceof h.get().getWebGLRenderingContext() ? t.srgb && (n = {
...
var mt = 4, $ = class e {
	...
	generateCanvas(e) {
		let { pixels: t, width: n, height: r } = this.getPixels(e), i = h.get().createCanvas();
