import { B as e, F as t, M as n, O as r, P as i, R as a, S as o, T as s, _ as c, a as l, b as u, c as d, g as f, j as p, k as m, o as h, p as g, s as _, u as ee, v as te, w as v, x as y, y as b, z as x } from "./Geometry-BuU6bpP9.js";
import { _ as ne, a as S, c as C, d as re, l as ie, m as ae, n as oe, o as se, p as ce, r as w, t as le, u as T } from "./Filter-N7Ki-nhd.js";
import { n as ue, p as E } from "./GCManagedHash-E8AM71m2.js";
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/environment/autoDetectEnvironment.mjs
var D = [];
e.handleByNamedList(x.Environment, D);
async function de(e) {
...
var k = /* @__PURE__ */ ((e) => (e[e.NONE = 0] = "NONE", e[e.COLOR = 16384] = "COLOR", e[e.STENCIL = 1024] = "STENCIL", e[e.DEPTH = 256] = "DEPTH", e[e.COLOR_DEPTH = 16640] = "COLOR_DEPTH", e[e.COLOR_STENCIL = 17408] = "COLOR_STENCIL", e[e.DEPTH_STENCIL = 1280] = "DEPTH_STENCIL", e[e.ALL = 17664] = "ALL", e))(k || {}), pe = class {
	constructor(e) {
	...
	clear(e = {}) {
		...
		b.shared.setValue(r ?? this.background.colorRgba), t.renderTarget.clear(i, n, b.shared.toArray(), a ?? 0, o ?? 0);
	}
	get resolution() {
...
var ge = he, A = "8.19.0", _e = class {
	static init() {
		globalThis.__PIXI_APP_INIT__?.(this, A);
	}
	static destroy() {}
};
_e.extension = x.Application;
var ve = class {
	constructor(e) {
		this._renderer = e;
	}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/filters/mask/mask.frag.mjs
var ye = "in vec2 vMaskCoord;\nin vec2 vTextureCoord;\n\nuniform sampler2D uTexture;\nuniform sampler2D uMaskTexture;\n\nuniform float uAlpha;\nuniform vec4 uMaskClamp;\nuniform float uInverse;\nuniform float uChannel;\n\nout vec4 finalColor;\n\nvoid main(void)\n{\n    float clip = step(3.5,\n        step(uMaskClamp.x, vMaskCoord.x) +\n        step(uMaskClamp.y, vMaskCoord.y) +\n        step(vMaskCoord.x, uMaskClamp.z) +\n        step(vMaskCoord.y, uMaskClamp.w));\n\n    // TODO look into why this is needed\n    float npmAlpha = uAlpha;\n    vec4 original = texture(uTexture, vTextureCoord);\n    vec4 masky = texture(uMaskTexture, vMaskCoord);\n\n    float a;\n    if (uChannel == 1.0) {\n        a = masky.a * npmAlpha * clip;\n    } else {\n        float alphaMul = 1.0 - npmAlpha * (1.0 - masky.a);\n        a = alphaMul * masky.r * npmAlpha * clip;\n    }\n\n    if (uInverse == 1.0) {\n        a = 1.0 - a;\n    }\n\n    finalColor = original * a;\n}\n", be = "in vec2 aPosition;\n\nout vec2 vTextureCoord;\nout vec2 vMaskCoord;\n\n\nuniform vec4 uInputSize;\nuniform vec4 uOutputFrame;\nuniform vec4 uOutputTexture;\nuniform mat3 uFilterMatrix;\n\nvec4 filterVertexPosition(  vec2 aPosition )\n{\n    vec2 position = aPosition * uOutputFrame.zw + uOutputFrame.xy;\n       \n    position.x = position.x * (2.0 / uOutputTexture.x) - 1.0;\n    position.y = position.y * (2.0*uOutputTexture.z / uOutputTexture.y) - uOutputTexture.z;\n\n    return vec4(position, 0.0, 1.0);\n}\n\nvec2 filterTextureCoord(  vec2 aPosition )\n{\n    return aPosition * (uOutputFrame.zw * uInputSize.zw);\n}\n\nvec2 getFilterCoord( vec2 aPosition )\n{\n    return  ( uFilterMatrix * vec3( filterTextureCoord(aPosition), 1.0)  ).xy;\n}   \n\nvoid main(void)\n{\n    gl_Position = filterVertexPosition(aPosition);\n    vTextureCoord = filterTextureCoord(aPosition);\n    vMaskCoord = getFilterCoord(aPosition);\n}\n", j = "struct GlobalFilterUniforms {\n  uInputSize:vec4<f32>,\n  uInputPixel:vec4<f32>,\n  uInputClamp:vec4<f32>,\n  uOutputFrame:vec4<f32>,\n  uGlobalFrame:vec4<f32>,\n  uOutputTexture:vec4<f32>,\n};\n\nstruct MaskUniforms {\n  uFilterMatrix:mat3x3<f32>,\n  uMaskClamp:vec4<f32>,\n  uAlpha:f32,\n  uInverse:f32,\n  uChannel:f32,\n};\n\n@group(0) @binding(0) var<uniform> gfu: GlobalFilterUniforms;\n@group(0) @binding(1) var uTexture: texture_2d<f32>;\n@group(0) @binding(2) var uSampler : sampler;\n\n@group(1) @binding(0) var<uniform> filterUniforms : MaskUniforms;\n@group(1) @binding(1) var uMaskTexture: texture_2d<f32>;\n\nstruct VSOutput {\n    @builtin(position) position: vec4<f32>,\n    @location(0) uv : vec2<f32>,\n    @location(1) filterUv : vec2<f32>,\n};\n\nfn filterVertexPosition(aPosition:vec2<f32>) -> vec4<f32>\n{\n    var position = aPosition * gfu.uOutputFrame.zw + gfu.uOutputFrame.xy;\n\n    position.x = position.x * (2.0 / gfu.uOutputTexture.x) - 1.0;\n    position.y = position.y * (2.0*gfu.uOutputTexture.z / gfu.uOutputTexture.y) - gfu.uOutputTexture.z;\n\n    return vec4(position, 0.0, 1.0);\n}\n\nfn filterTextureCoord( aPosition:vec2<f32> ) -> vec2<f32>\n{\n    return aPosition * (gfu.uOutputFrame.zw * gfu.uInputSize.zw);\n}\n\nfn globalTextureCoord( aPosition:vec2<f32> ) -> vec2<f32>\n{\n  return  (aPosition.xy / gfu.uGlobalFrame.zw) + (gfu.uGlobalFrame.xy / gfu.uGlobalFrame.zw);\n}\n\nfn getFilterCoord(aPosition:vec2<f32> ) -> vec2<f32>\n{\n  return ( filterUniforms.uFilterMatrix * vec3( filterTextureCoord(aPosition), 1.0)  ).xy;\n}\n\nfn getSize() -> vec2<f32>\n{\n  return gfu.uGlobalFrame.zw;\n}\n\n@vertex\nfn mainVertex(\n  @location(0) aPosition : vec2<f32>,\n) -> VSOutput {\n  return VSOutput(\n   filterVertexPosition(aPosition),\n   filterTextureCoord(aPosition),\n   getFilterCoord(aPosition)\n  );\n}\n\n@fragment\nfn mainFragment(\n  @location(0) uv: vec2<f32>,\n  @location(1) filterUv: vec2<f32>,\n  @builtin(position) position: vec4<f32>\n) -> @location(0) vec4<f32> {\n\n    var maskClamp = filterUniforms.uMaskClamp;\n    var uAlpha = filterUniforms.uAlpha;\n\n    var clip = step(3.5,\n      step(maskClamp.x, filterUv.x) +\n      step(maskClamp.y, filterUv.y) +\n      step(filterUv.x, maskClamp.z) +\n      step(filterUv.y, maskClamp.w));\n\n    var mask = textureSample(uMaskTexture, uSampler, filterUv);\n    var source = textureSample(uTexture, uSampler, uv);\n\n    var a: f32;\n    if (filterUniforms.uChannel == 1.0) {\n        a = mask.a * uAlpha * clip;\n    } else {\n        var alphaMul = 1.0 - uAlpha * (1.0 - mask.a);\n        a = alphaMul * mask.r * uAlpha * clip;\n    }\n\n    if (filterUniforms.uInverse == 1.0) {\n        a = 1.0 - a;\n    }\n\n    return source * a;\n}\n", xe = class extends le {
	constructor(e) {
		let { sprite: t, ...n } = e, r = new o(t.texture), a = new _({
			uFilterMatrix: {
				value: new i(),
				type: "mat3x3<f32>"
			},
...
var N = class {
	...
	buildStart(e) {
		...
		t || (t = this._batchersByInstructionSet[e.uid] = /* @__PURE__ */ Object.create(null), t.default || (t.default = new ue({ maxTextures: this.renderer.limits.maxBatchableTextures }))), this._activeBatches = t, this._activeBatch = this._activeBatches.default;
	...
	execute(e) {
		...
		if (e.action === "pushMaskBegin") {
			...
			if (r.inverse = e.inverse, r.channel = e.mask.channel, n) {
				...
				let n = ae(e.mask.mask, !0, Se);
				e.mask.mask.measurable = !1, n.ceil();
				let i = t.renderTarget.renderTarget.colorTexture.source, a = T.getOptimalTexture(n.width, n.height, i._resolution, i.antialias);
			...
			n && T.returnTexture(e.filterTexture), f.return(e.filterEffect);
		}
	}
	destroy() {
...
var Te = class {
	...
	execute(e) {
		...
		e.action === "pushMaskBegin" ? (r.renderTarget.ensureDepthStencil(), r.stencil.setStencilMode(E.RENDERING_MASK_ADD, a), a++, r.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? r.stencil.setStencilMode(E.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(E.MASK_ACTIVE, a), r.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (r.colorMask.setMask(0), a === 0 ? (r.renderTarget.clear(null, k.STENCIL), r.stencil.setStencilMode(E.DISABLED, a)) : r.stencil.setStencilMode(E.RENDERING_MASK_REMOVE, a), a--) : e.action === "popMaskEnd" && (e.inverse ? r.stencil.setStencilMode(E.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(E.MASK_ACTIVE, a), r.colorMask.setMask(15)), this._maskStackHash[i] = a;
	}
	destroy() {
...
var H = class {
	...
	_beginAdvancedBlendMode(e, t) {
		...
		if (!V[n]) {
			te(`Unable to assign BlendMode: '${n}'. You may want to include: import 'pixi.js/advanced-blend-modes'`);
			return;
		}
		let r = this._ensureFilterEffect(n), i = e instanceof ie, a = {
			renderPipeId: "filter",
			action: "pushFilter",
			filterEffect: r,
	...
	_ensureFilterEffect(e) {
		...
		return t || (t = this._filterHash[e] = new ne(), t.filters = [new V[e]()]), t;
	}
...
function ke(e) {
	...
	if (e.renderGroupParent) {
		...
		e.worldTransform.appendFrom(t.relativeGroupTransform, r.worldTransform), e.worldColor = ce(t.groupColor, r.worldColor), n = t.groupAlpha * r.worldAlpha;
...
function je(e, t, n) {
	if (n & 1) {
		e.groupColor = ce(e.localColor, t.groupColor);
	...
	_updateCachedRenderGroups(e, t) {
		...
		if (e.invalidateMatrices(), e.isCachedAsTexture) {
			if (e.textureNeedsUpdate) {
				...
				t.ceil(), e.texture && T.returnTexture(e.texture, !0);
				let c = T.getOptimalTexture(t.width, t.height, r, i);
		...
		} else e.texture &&= (T.returnTexture(e.texture, !0), null);
	}
...
var W = class e {
	constructor() {
		this.clearBeforeRender = !0, this._backgroundColor = new b(0), this.color = this._backgroundColor, this.alpha = 1;
	}
	init(t) {
		t = {
			...e.defaultOptions,
	...
	set color(e) {
		b.shared.setValue(e).alpha < 1 && this._backgroundColor.alpha === 1 && te("Cannot set a transparent background on an opaque canvas. To enable transparency, set backgroundAlpha < 1 when initializing your Application."), this._backgroundColor.setValue(e);
	}
	get alpha() {
...
var Fe = W, G = {
	...
	_normalizeOptions(e, t = {}) {
		return e instanceof C || e instanceof y ? {
			target: e,
			...t
		} : {
			...t,
	...
	canvas(e) {
		...
		if (t instanceof y) return n.texture.generateCanvas(t);
		let r = n.textureGenerator.generateTexture(e), i = n.texture.generateCanvas(r);
		return r.destroy(!0), i;
	}
	pixels(e) {
		e = this._normalizeOptions(e);
		let t = e.target, n = this._renderer, r = t instanceof y ? t : n.textureGenerator.generateTexture(e), i = n.texture.getPixels(r);
		return t instanceof C && r.destroy(!0), i;
	}
	texture(e) {
		return e = this._normalizeOptions(e), e.target instanceof y ? e.target : this._renderer.textureGenerator.generateTexture(e);
	}
	download(e) {
		e = this._normalizeOptions(e);
...
var Ie = K, Le = class e extends y {
	...
	generateTexture(e) {
		...
		a = a ? Array.isArray(a) && a.length === 4 ? a : b.shared.setValue(a).toArray() : Be;
...
var We = q, Ge = class {
	...
	bind({ size: e, projectionMatrix: n, worldTransformMatrix: r, worldColor: a, offset: o }) {
		...
		let d = u.uniforms;
		d.uProjectionMatrix = l.projectionMatrix, d.uResolution = l.resolution, d.uWorldTransformMatrix.copyFrom(l.worldTransformMatrix), d.uWorldTransformMatrix.tx -= l.offset.x, d.uWorldTransformMatrix.ty -= l.offset.y, M(l.worldColor, d.uWorldColorAlpha, 0), u.update();
		let f;
...
var Ze = X, Qe = class e {
	constructor(t = {}) {
		...
		this.colorTexture.source.on("resize", this.onSourceResize, this), (t.depthStencilTexture || this.stencil) && (t.depthStencilTexture instanceof y || t.depthStencilTexture instanceof v ? this.depthStencilTexture = t.depthStencilTexture.source : this.ensureDepthStencilTexture());
	}
	get size() {
		let e = this._size;
...
var it = class {
	constructor(e) {
		this.rootViewPort = new n(), this.viewport = new n(), this.mipLevel = 0, this.layer = 0, this.onRenderTargetChange = new pe("onRenderTargetChange"), this.projectionMatrix = new i(), this.defaultClearColor = [
			0,
			0,
			0,
			0
	...
	bind(e, t = !0, n, r, i = 0, a = 0) {
		...
		if (!r && e instanceof y && (r = e.frame), r) {
	...
	_initRenderTarget(e) {
		let t = null;
		return S.test(e) && (e = $e(e).source), e instanceof Z ? t = e : e instanceof v && (t = new Z({ colorTextures: [e] }), e.source instanceof S && (t.isRoot = !0), e.once("destroy", () => {
...
//#endregion
export { B as a, I as c, M as d, _e as f, fe as h, H as i, F as l, k as m, tt as n, z as o, ge as p, et as r, L as s, it as t, N as u };

//# sourceMappingURL=RenderTargetSystem-CrhszbVu.js.map
