...
var Ce = class {
	...
	getDescriptor(e, t, n, r = 0, i = 0) {
		...
		if ((e.stencil || e.depth) && !e.depthStencilTexture && (e.ensureDepthStencilTexture(), e.depthStencilTexture.source.sampleCount = o.msaa ? 4 : 1, e.depthStencilTexture.source.transient = !!o.msaaTextures[0]?.transient), e.depthStencilTexture) {
			let n = t & _.STENCIL ? "clear" : "load", a = t & _.DEPTH ? "clear" : "load", o = e.depthStencilTexture.source.transient ? "discard" : "store";
			c = {
...
var U = class {
	...
	getColorTargets(e, t) {
		let n = H[e.blendMode] || H.normal, r = [], i = {
			format: "bgra8unorm",
			writeMask: 0,
			blend: n
		};
...
var Te = {
	...
	type: "compressed",
	upload(e, t, n, r = 0) {
		let i = e.pixelWidth, a = e.pixelHeight, o = W[e.format] || Ee;
...
var X = class {
	...
	execute(e, t) {
		...
		let a = i.gpuProgram;
		if (a.autoAssignGlobalUniforms && (i.groups[0] = r.globalUniforms.bindGroup), a.autoAssignLocalUniforms) {
