import { $ as e, B as t, C as n, I as r, R as i, c as a, f as o, i as s, it as c, l, rt as u, s as d, t as f, u as p } from "./Geometry-CW_aidqb.js";
import { t as m } from "./getPo2TextureFromSource-Df-ffBe0.js";
import { t as h } from "./canvasUtils-BhZPiFjM.js";
import { t as g } from "./CanvasPool-BTs3zFci.js";
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/bounds/getRenderableBounds.mjs
var _ = new e();
function v(e, t) {
	t.clear();
	let n = t.matrix;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/filters/CanvasFilterSystem.mjs
function y(e) {
	return typeof e.getCanvasFilterString == "function";
}
var b = class {
	constructor() {
		this.skip = !1, this.useClip = !1, this.filters = null, this.container = null, this.bounds = new i(), this.cssFilterString = "";
	}
}, x = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/filters/defaults/defaultFilter.vert.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/filters/FilterSystem.mjs
var D = new f({
	...
	constructor() {
		this.skip = !1, this.inputTexture = null, this.backTexture = null, this.filters = null, this.bounds = new i(), this.container = null, this.blendRequired = !1, this.outputRenderSurface = null, this.globalFrame = {
			x: 0,
			y: 0,
			width: 0,
			height: 0
	...
	generateFilteredTexture({ texture: e, filters: r }) {
		...
		this._activeFilterData = i, i.skip = !1, i.filters = r;
		let a = e.source, o = a.resolution, s = a.antialias;
		if (r.every((e) => !e.enabled)) return i.skip = !0, e;
		let c = i.bounds;
		if (c.addRect(e.frame), this._calculateFilterBounds(i, c.rectangle, s, o, 0), i.skip) return e;
		let l = o;
		this._calculateGlobalFrame(i, 0, 0, l, a.width, a.height), i.outputRenderSurface = n.getOptimalTexture(c.width, c.height, i.resolution, i.antialias), i.backTexture = t.EMPTY, i.inputTexture = e, this.renderer.renderTarget.finishRenderPass(), this._applyFiltersToTexture(i, !0);
		let u = i.outputRenderSurface;
		return u.source.alphaMode = "premultiplied-alpha", u;
	}
	pop() {
		let e = this.renderer, t = this._popFilterData();
		t.skip || (e.globalUniforms.pop(), e.renderTarget.finishRenderPass(), this._activeFilterData = t, this._applyFiltersToTexture(t, !1), t.blendRequired && n.returnTexture(t.backTexture), n.returnTexture(t.inputTexture));
	}
	getBackTexture(e, t, r) {
		let i = e.colorTexture.source._resolution, a = n.getOptimalTexture(t.width, t.height, i, !1), o = t.minX, s = t.minY;
		r && (o -= r.minX, s -= r.minY), o = Math.floor(o * i), s = Math.floor(s * i);
		let c = Math.ceil(t.width * i), l = Math.ceil(t.height * i);
	...
	calculateSpriteMatrix(t, n) {
		let r = this._activeFilterData, i = t.set(r.inputTexture._source.width, 0, 0, r.inputTexture._source.height, r.bounds.minX, r.bounds.minY), a = n.worldTransform.copyTo(e.shared), o = n.renderGroup || n.parentRenderGroup;
	...
	_setupBindGroupsAndRender(e, t, n) {
		...
		}), n.type === d.WEBGL && n.renderTarget.finishRenderPass();
	}
	_setupFilterTextures(e, r, i, a) {
		if (e.backTexture = t.EMPTY, e.inputTexture = n.getOptimalTexture(r.width, r.height, e.resolution, e.antialias), e.blendRequired) {
			i.renderTarget.finishRenderPass();
			let t = i.renderTarget.getRenderTarget(e.outputRenderSurface);
			e.backTexture = this.getBackTexture(t, r, a?.bounds);
		}
		i.renderTarget.bind(e.inputTexture, !0), i.globalUniforms.push({ offset: r });
	}
	_calculateGlobalFrame(e, t, n, r, i, a) {
		let o = e.globalFrame;
		o.x = t * r, o.y = n * r, o.width = i * r, o.height = a * r;
	}
	_updateFilterUniforms(e, n, r, i, a, o, s, c) {
		...
		s ? (u[0] = r.bounds.minX - i, u[1] = r.bounds.minY - a) : (u[0] = 0, u[1] = 0), u[2] = e.frame.width, u[3] = e.frame.height, d[0] = e.source.width, d[1] = e.source.height, d[2] = 1 / d[0], d[3] = 1 / d[1], f[0] = e.source.pixelWidth, f[1] = e.source.pixelHeight, f[2] = 1 / f[0], f[3] = 1 / f[1], p[0] = .5 * f[2], p[1] = .5 * f[3], p[2] = e.frame.width * d[2] - .5 * f[2], p[3] = e.frame.height * d[3] - .5 * f[3];
		let g = this.renderer.renderTarget.rootRenderTarget.colorTexture;
		m[0] = i * o, m[1] = a * o, m[2] = g.source.width * o, m[3] = g.source.height * o, n instanceof t && (n.source.resource = null);
		let _ = this.renderer.renderTarget.getRenderTarget(n);
		this.renderer.renderTarget.bind(n, !!c), n instanceof t ? (h[0] = n.frame.width, h[1] = n.frame.height) : (h[0] = _.width, h[1] = _.height), h[2] = _.isRoot ? -1 : 1, this._filterGlobalUniforms.update();
	}
	...
	_applyFiltersToTexture(e, t) {
		let r = e.inputTexture, i = e.bounds, a = e.filters, o = e.firstEnabledIndex, s = e.lastEnabledIndex;
		if (this._globalFilterBindGroup.setResource(r.source.style, 2), this._globalFilterBindGroup.setResource(e.backTexture.source, 3), o === s) a[o].apply(this, r, e.outputRenderSurface, t);
		else {
			let r = e.inputTexture, c = n.getOptimalTexture(i.width, i.height, r.source._resolution, !1), l = c;
			for (let e = o; e < s; e++) {
				let t = a[e];
			...
			a[s].apply(this, r, e.outputRenderSurface, t), n.returnTexture(c);
		}
	}
	_calculateFilterBounds(e, t, n, i, a) {
		let o = this.renderer, s = e.bounds, c = e.filters, l = Infinity, u = 0, d = !0, f = !1, p = !1, m = !0, h = -1, g = -1;
		for (let e = 0; e < c.length; e++) {
			let t = c[e];
			if (t.enabled) {
				if (h === -1 && (h = e), g = e, l = Math.min(l, t.resolution === "inherit" ? i : t.resolution), u += t.padding, t.antialias === "off" ? d = !1 : t.antialias === "inherit" && (d &&= n), t.clipToViewport || (m = !1), !(t.compatibleRenderers & o.type)) {
					p = !1;
					break;
				}
				if (t.blendRequired && !(o.backBuffer?.useBackBuffer ?? !0)) {
					r("Blend filter requires backBuffer on WebGL renderer to be enabled. Set `useBackBuffer: true` in the renderer options."), p = !1;
					break;
				}
...
//# sourceMappingURL=init-CSFPxMDL.js.map
