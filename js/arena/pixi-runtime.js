...
import { a as te, i as ne, n as D, o as re, r as O, s as k } from "./CanvasRenderer-BB6FIAvI.js";
import { t as ie } from "./CanvasPool-BTs3zFci.js";
...
var ce;
async function le(e = {}) {
	return ce === void 0 && (ce = await (async () => {
...
async function de(e) {
	let t = [];
	e.preference ? Array.isArray(e.preference) ? t = e.preference.slice() : (t.push(e.preference), ue.forEach((n) => {
		n !== e.preference && t.push(n);
	})) : t = ue.slice();
	let n, r = {};
	for (let i = 0; i < t.length; i++) {
		let a = t[i];
		if (a === "webgpu" && await le()) {
...
pe.extension = _.Application, m.add(fe), m.add(pe);
//#endregion
...
var me = class e {
	...
	async init(t) {
		t = { ...t }, this.stage ||= new b(), this.renderer = await de(t), e._plugins.forEach((e) => {
			e.init.call(this, t);
		});
	}
	render() {
...
me._plugins = [];
var he = me;
m.handleByList(_.Application, he._plugins), m.add(T);
//#endregion
...
var j = null, M = null;
function ve(e, t) {
	j || (j = y.get().createCanvas(256, 128), M = j.getContext("2d", { willReadFrequently: !0 }), M.globalCompositeOperation = "copy", M.globalAlpha = 1), (j.width < e || j.height < t) && (j.width = a(e), j.height = a(t));
}
function ye(e, t, n) {
...
function xe(...e) {
	...
	if (ve(i, a), !M) throw TypeError("Failed to get canvas 2D context");
	M.drawImage(n, 0, 0, i, a, 0, 0, i * r, a * r);
	let s = M.getImageData(0, 0, i, a).data, c = 0, l = 0, d = i - 1, f = a - 1;
	for (; l < a && ye(s, i, l);) ++l;
	if (l === a) return u.EMPTY;
	for (; ye(s, i, f);) --f;
	for (; be(s, i, c, l, f);) ++c;
	for (; be(s, i, d, l, f);) --d;
	return ++d, ++f, M.globalCompositeOperation = "source-over", M.strokeRect(c, l, d - c, f - l), M.globalCompositeOperation = "copy", o ??= new u(), o.set(c / r, l / r, (d - c) / r, (f - l) / r), o;
}
//#endregion
...
var Oe = /* @__PURE__ */ new Set([10, 13]), ke = /* @__PURE__ */ new Set([
	9,
	32,
	8192,
	8193,
...
function Ne(e) {
	return typeof e == "string" && Ae.has(e.charCodeAt(0));
}
function Pe(e) {
...
function Ie(e) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		n.push(i), Ne(i) && a && !P(a) && !N(a) && (t.push(n.join("")), n.length = 0);
	}
...
function ze(e, t, n, r, i, a, o, s, c) {
	let l = De(e, t);
	if (Fe(t.whiteSpace)) for (let e = 0; e < l.length; e++) {
		let t = l[e];
		l[e] = {
			text: t.text.replace(Re, " "),
			style: t.style
		};
	}
	let u = [], d = [];
	for (let e of l) {
		let t = e.text.split(je);
	...
	let f = n ? Be(u, t, r, a, s, c) : u, p = [], m = [], h = [], g = [], _ = [], v = 0, y = t._fontString, b = o(y);
...
function Be(e, t, n, r, i, a) {
	let { letterSpacing: o, whiteSpace: s, wordWrapWidth: c, breakWords: l } = t, u = Pe(s), d = c + o, f = {}, p = "", m = (e, t) => {
	...
	for (let t of e) {
		let e = Ve(t), n = h.length, r = (t) => {
			...
			if (g(), s.length > 0) {
				let e = s[s.length - 1];
				e.text = F(e.text), e.text.length === 0 && s.pop();
			}
			h.push(s), s = [], c = 0, f = !1;
		};
		for (let t = 0; t < e.length; t++) {
			...
			if (u) {
				let e = P(n), t = p?.text[p.text.length - 1] ?? s[s.length - 1]?.text.slice(-1) ?? "", r = t ? P(t) : !1;
				if (e && r) continue;
			}
			let x = !y, S = x ? r(t) : b;
			if (S > d && x) {
				if (c > 0 && _(), l) {
					let e = o(t);
					for (let t = 0; t < e.length; t++) {
						let n = e[t].token, r = e[t].style, o = Le(n, l, a, i);
						for (let e of o) {
							let t = m(e, r);
...
var He = { willReadFrequently: !0 };
function Ue(e, t, n, r, i) {
	let a = n[e];
	return typeof a != "number" && (a = i(e, t, r) + t, n[e] = a), a;
}
function We(e, t, n, r, i, a, o) {
	let s = n.getContext("2d", He);
	s.font = t._fontString;
	let c = 0, l = "", u = [], d = /* @__PURE__ */ Object.create(null), { letterSpacing: f, whiteSpace: p } = t, m = Pe(p), h = Fe(p), g = !m, _ = t.wordWrapWidth + f, v = Ie(e);
	for (let e = 0; e < v.length; e++) {
		let n = v[e];
		if (N(n)) {
			if (!h) {
				u.push(F(l)), g = !m, l = "", c = 0;
				continue;
			}
			n = " ";
		}
		if (m) {
			let e = P(n), t = P(l[l.length - 1]);
			if (e && t) continue;
		}
		let p = Ue(n, f, d, s, r);
		if (p > _) {
			if (l !== "" && (u.push(F(l)), l = "", c = 0), i(n, t.breakWords)) {
				let e = Le(n, t.breakWords, o, a);
				for (let t of e) {
					let e = Ue(t, f, d, s, r);
					e + c > _ && (u.push(F(l)), g = !1, l = "", c = 0), l += t, c += e;
				}
			} else l.length > 0 && (u.push(F(l)), l = "", c = 0), u.push(F(n)), g = !1, l = "", c = 0;
		} else p + c > _ && (g = !1, u.push(F(l)), l = "", c = 0), (l.length > 0 || !P(n) || g) && (l += n, c += p);
	}
	let y = F(l);
...
var Ge = { willReadFrequently: !0 }, I = class e {
	...
	static measureText(t = " ", n, r = e._canvas, i = n.wordWrap) {
		...
		if (we(n) && Te(t)) {
			let r = ze(t, n, i, e._context, e._measureText, e._measureTextAdvance, e.measureFont, e.canBreakChars, e.wordWrapSplit), o = new e(t, n, r.width, r.height, r.lines, r.lineWidths, r.lineHeight, r.maxLineWidth, r.fontProperties, {
		...
		let c = e._context;
		c.font = o;
		let l = (i ? e._wordWrap(t, n, r) : t).split(Me), u = Array(l.length), d = 0;
	...
	static _wordWrap(t, n, r = e._canvas) {
		return We(t, n, r, e._measureTextAdvance, e.canBreakWords, e.canBreakChars, e.wordWrapSplit);
	}
	...
	static get _canvas() {
		if (!e.__canvas) {
			...
			try {
				...
				if (n.getContext("2d", Ge)?.measureText) return e.__canvas = n, n;
	...
	static get _context() {
		return e.__context ||= e._canvas.getContext("2d", Ge), e.__context;
	}
};
I.METRICS_STRING = "|ÉqÅ", I.BASELINE_SYMBOL = "M", I.BASELINE_MULTIPLIER = 1.4, I.HEIGHT_MULTIPLIER = 2, I.graphemeSegmenter = (() => {
	...
	return (e) => [...e];
})(), I.experimentalLetterSpacing = !1, I._fonts = {}, I._measurementCache = Ce(1e3);
var L = I, Ke = [
	"serif",
	"sans-serif",
	"monospace",
...
function R(e) {
	...
	for (let e = n.length - 1; e >= 0; e--) {
		let t = n[e].trim();
		!/([\"\'])[^\'\"]+\1/.test(t) && !Ke.includes(t) && (t = `"${t}"`), n[e] = t;
	}
		...
		if (p && r && a) {
			...
			for (let n = 0; n < a.lines.length; n++) {
				...
				e.colorStops.forEach((e) => {
					let n = r + e.offset * t;
					n = Math.max(0, Math.min(1, n)), f.addColorStop(Math.floor(n * qe) / qe, o.shared.setValue(e.color).toHex());
				});
			}
...
var V = new class {
	getCanvasAndContext(e) {
		let { text: t, style: n, resolution: r = 1 } = e, i = n._getFinalPadding(), a = L.measureText(t || " ", n), o = Math.ceil(Math.ceil(Math.max(1, a.width) + i * 2) * r), s = Math.ceil(Math.ceil(Math.max(1, a.height) + i * 2) * r), c = ie.getOptimalCanvasAndContext(o, s);
	...
	_renderTextToCanvas(e, t, n, r, i) {
		...
		let { canvas: a, context: o } = r, s = R(e), c = i.lines, l = i.lineHeight, u = i.lineWidths, d = i.maxLineWidth, f = i.fontProperties, p = a.height;
	...
	_renderTaggedTextToCanvas(e, t, n, r, i) {
		...
		for (let e = 0; e < s.length; e++) {
			...
			for (let e of t) {
				let t = R(e.style);
				o.font = t, n.push({
					width: L._measureText(e.text, e.style.letterSpacing, o),
					font: t
				});
			}
			_.push(n);
				...
				for (let e = 0; e < f.length; e++) {
					...
					if (o.font = c, o.textBaseline = t.style.textBaseline, t.style._stroke?.width) {
						...
						if (o.lineWidth = e.width, o.miterLimit = e.miterLimit, o.lineJoin = e.join, o.lineCap = e.cap, a) {
							...
							let r = L.measureFont(c), i = t.style.lineHeight || r.fontSize;
							o.strokeStyle = z(e, o, {
								width: s,
								height: i,
								lineHeight: i,
				...
				for (let e = 0; e < f.length; e++) {
					...
					if (o.font = c, o.textBaseline = t.style.textBaseline, t.style._fill !== void 0) {
						if (a) {
							...
							let e = L.measureFont(c), r = t.style.lineHeight || e.fontSize, i = {
								width: s,
								height: r,
								lineHeight: r,
								lines: [t.text]
							};
							o.fillStyle = z(t.style._fill, o, i, n * 2, T - n, v);
						}
	...
	_setFillAndStrokeStyles(e, t, n, r, i, a = 0, o = 0) {
		if (e.fillStyle = t._fill ? z(t._fill, e, n, r * 2, a, o) : null, t._stroke?.width) {
			let s = i + r * 2;
			e.strokeStyle = z(t._stroke, e, n, s, a, o);
		}
	}
	...
	_drawLetterSpacing(e, t, n, r, i, a = !1, o = 0) {
		...
		if (L.experimentalLetterSpacingSupported && (L.experimentalLetterSpacing ? (s.letterSpacing = `${c}px`, s.textLetterSpacing = `${c}px`, l = !0) : (s.letterSpacing = "0px", s.textLetterSpacing = "0px")), (c === 0 || l) && o === 0) {
		...
		let u = r, d = L.graphemeSegmenter(e), f = s.measureText(e).width, p = 0;
...
}(), Ye = class e extends v {
	constructor(t = {}) {
		super(), this.uid = l("textStyle"), this._tick = 0, this._cachedFontString = null, Xe(t), t instanceof e && (t = t._toObject());
		let n = {
			...e.defaultTextStyle,
			...t
		};
	...
	set fill(e) {
		e !== this._originalFill && (this._originalFill = e, this._isFillStyle(e) && (this._originalFill = this._createProxy({
			...
			this._fill = ne({ ...this._originalFill }, O.defaultFillStyle);
		})), this._fill = ne(e === 0 ? "black" : e, O.defaultFillStyle), this.update());
	}
	get stroke() {
	...
	set stroke(e) {
		e !== this._originalStroke && (this._originalStroke = e, this._isFillStyle(e) && (this._originalStroke = this._createProxy({
			...O.defaultStrokeStyle,
			...e
		}, () => {
			this._stroke = te({ ...this._originalStroke }, O.defaultStrokeStyle);
		})), this._stroke = te(e, O.defaultStrokeStyle), this.update());
	}
	get tagStyles() {
	...
	get _fontString() {
		return this._cachedFontString === null && (this._cachedFontString = R(this)), this._cachedFontString;
	}
	_toObject() {
		return {
			align: this.align,
...
function Xe(e) {
	...
	if (t.strokeThickness !== void 0) {
		...
		else if (n instanceof k || n instanceof re) r.fill = n;
...
var Qe = class extends ee {}, $e = class {
	constructor(e) {
	...
	addRenderable(e, t) {
		...
		if (e._didTextUpdate) {
			...
			(n.currentKey !== e.styleKey || e._resolution !== t) && this._updateGpuText(e), e._didTextUpdate = !1, Ze(n, e);
		}
...
var et = class {
	...
	getTexture(e, t, n, r) {
		typeof e == "string" && (g("8.0.0", "CanvasTextSystem.getTexture: Use object TextOptions instead of separate arguments"), e = {
			...
			style: n,
			resolution: t
		}), e.style instanceof H || (e.style = new H(e.style)), e.textureStyle instanceof c || (e.textureStyle = new c(e.textureStyle)), typeof e.text != "string" && (e.text = e.text.toString());
		let { text: i, style: a, textureStyle: o, autoGenerateMipmaps: s } = e, l = e.resolution ?? this._renderer.resolution, { frame: u, canvasAndContext: d } = V.getCanvasAndContext({
			text: i,
			style: a,
			resolution: l
		...
		if (o && (f.source.style = o), a.trim && (u.pad(a.padding), f.frame.copyFrom(u), f.frame.scale(1 / l), f.updateUvs()), a.filters) {
			...
			return this.returnTexture(f), V.returnCanvasAndContext(d), e;
		}
		return this._renderer.texture.initSource(f._source), this._retainCanvasContext || V.returnCanvasAndContext(d), f;
	}
	returnTexture(e) {
		let t = e.source, r = t.resource;
		if (this._retainCanvasContext && r?.getContext) {
			let e = r.getContext("2d");
			e && V.returnCanvasAndContext({
				canvas: r,
				context: e
			});
		}
...
nt.extension = {
	...
	name: "canvasText"
}, m.add(tt), m.add(nt), m.add($e);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/text/Text.mjs
var rt = class extends ge {
	constructor(...e) {
		let t = _e(e, "Text");
		super(t, H), this.renderPipeId = "text", t.textureStyle && (this.textureStyle = t.textureStyle instanceof c ? t.textureStyle : new c(t.textureStyle)), this.autoGenerateMipmaps = t.autoGenerateMipmaps ?? s.defaultOptions.autoGenerateMipmaps;
	}
	updateBounds() {
		let e = this._bounds, t = this._anchor, n = 0, r = 0;
		if (this._style.trim) {
			let { frame: e, canvasAndContext: t } = V.getCanvasAndContext({
				text: this.text,
				style: this._style,
				resolution: 1
			});
			V.returnCanvasAndContext(t), n = e.width, r = e.height;
		} else {
			let e = L.measureText(this._text, this._style);
...
var it = /^#[0-9a-f]{6}$/i, at = /* @__PURE__ */ new Set([
	"none",
	"bandana",
	"visor",
	"crown",
...
function st(e, t = "#38bdf8") {
	...
	return {
		...
		accessory: at.has(n.accessory) ? n.accessory : "none",
		expression: ot.has(n.expression) ? n.expression : "focused"
	};
}
function ct(e, t, n) {
	return t ? "win" : e && [
...
function pt(e, t) {
	...
	if (i <= a) return ft * i;
	let o = ft * a, s = (1 - i) / .18000000000000005;
	return o + .09890109890109888 * (1 - s * s);
}
var mt = 1.02;
function ht(e, t) {
	let n = pt(e, t);
...
function wt(e) {
	let t = St((e - lt) / .1499999999999999), n = t * Ct;
	return {
...
function Dt(e, t) {
	let n = (t ? e[1] : e[0])?.finishMs;
	return n == null ? Infinity : Math.max(n, gt(e[0]?.finishMs ?? n));
}
function Ot(e, t, n) {
	let r = e.order[0], i = e.order[1];
	if (!r || !i) return;
	let a = i.finishMs - r.finishMs;
	if (a < 0 || a > 180 || t) return;
	let o = n + 220, s = e.elapsedMs < n ? e.elapsedMs >= r.finishMs - 700 ? "approach" : "none" : e.elapsedMs < o ? "flash" : e.elapsedMs < o + 1350 ? "result" : "none";
	if (s !== "none") return {
		phase: s,
		firstId: e.racers[r.index]?.id ?? r.index,
		secondId: e.racers[i.index]?.id ?? i.index,
		firstName: e.racers[r.index]?.name || "Racer 1",
		secondName: e.racers[i.index]?.name || "Racer 2",
		firstMs: r.finishMs,
		secondMs: i.finishMs,
		gapMs: a
	};
...
function jt(e) {
	let t = e.order.at(-1)?.finishMs ?? Infinity, n = e.order[1]?.finishMs, r = n == null || !e.order[0] ? Infinity : n - e.order[0].finishMs, i = r >= 0 && r <= 180, a = Dt(e.order, i), o = e.elapsedMs >= a, s = e.elapsedMs >= t + 320 && o, c = i && n != null ? Et(e.elapsedMs, n) : e.elapsedMs, l = Ot(e, s, a), u = e.order[0]?.finishMs ?? Infinity, d = At(e.order, e.elapsedMs);
	return {
...
var Mt = .18, Nt = .92;
function Pt(e, t) {
	let n = Math.max(240, e), r = Math.max(240, t), i = r > n, a = r < 520 || n < 520, o = r * Mt, s = r * Nt, c = n * .03, l = n * .91, u = s - o, d = (n <= 640 ? 68 : 88) / 72;
	return {
		width: n,
		height: r,
		portrait: i,
...
function Ft(e, t, n, r = 0) {
	let i = Math.max(1, n), a = (Math.max(0, Math.min(i - 1, t)) + .5) / i;
	return e.laneTop + e.laneHeight * a;
}
function It(e, t, n) {
	if (!n) {
...
function Lt(e, t) {
	return t === 0 ? [...e] : e.map((n, r) => r >= Math.max(9, e.length - 6) ? t === 1 ? U(n, r % 2 == 0 ? 1 : -1) : t === 2 ? U(n, +(r % 3 == 0)) : U(n, r % 2 == 0 ? -1 : 1) : t === 1 || t === 3 ? U(n, 1) : n);
}
function W(e, t) {
...
var Rt = (e) => Math.max(0, Math.min(1, e)), zt = (e) => e <= 0 || e >= 1 ? 0 : Math.sin(e * Math.PI);
function Bt(e) {
	let t = Math.max(0, e);
	return {
		freeze: +(t < 115),
		converge: t < 760 ? zt((t - 80) / 680) : .72 + Math.sin(t * .006) * .08,
		launch: zt((t - 190) / 620),
		celebrate: t < 720 ? 0 : Math.abs(Math.sin((t - 720) * .014)) * Rt((t - 720) / 280),
		loserReaction: zt((t - 120) / 760)
	};
}
//#endregion
//#region src/arena/animation.ts
var Vt = Math.PI * 2, G = (e) => Math.max(0, Math.min(1, e)), Ht = (e) => 1 - (1 - G(e)) ** 3, K = (e) => Math.sin(G(e) * Math.PI), q = (e = 380) => ({
	x: 0,
	y: 0,
	scaleX: 1,
	scaleY: 1,
...
function Ut(e) {
	if (e.reducedMotion) {
		...
		return {
			...
			x: t.x * .42,
			y: t.y * .62,
			scaleX: 1 + (t.scaleX - 1) * .48,
			scaleY: 1 + (t.scaleY - 1) * .48,
			rotation: t.rotation * .42,
			strideMs: Math.max(390, t.strideMs * 1.35),
			afterimage: t.afterimage * .18,
			impact: t.impact * .35,
			dust: t.dust * .38,
			skid: t.skid * .62,
			energy: t.energy * .36
	...
	if (e.motion === "run") {
		let n = G(e.speed ?? t / 3), r = Math.max(-1, Math.min(1, e.acceleration ?? 0)), i = Math.max(235, 410 - t * 48), a = e.elapsedMs / i * Vt + e.lane * .61, o = Math.abs(Math.sin(a)), s = Math.max(0, Math.cos(a));
		return {
			...q(i),
			...
			frame: W(e.elapsedMs + e.lane * 31, i),
			dust: .2 + t * .13 + Math.max(0, r) * .18,
			energy: Math.max(0, r) * .28
		};
	}
	if (e.motion === "surge") {
		let e = G(n / 920), r = e < .12 ? e / .12 : 1, a = e < .12 ? 0 : K((e - .12) / .48), o = Ht((e - .6) / .4);
		return {
			...q(190),
			x: -3.4 * (1 - r) + a * 6.2 * (1 - o),
	...
	if (e.motion === "stumble") {
		let t = G(n / 1120), r = K(t / .16), i = t >= .16 && t < .58 ? K((t - .16) / .42) : 0, a = t >= .58 ? Ht((t - .58) / .42) : 0, o = e.variant >= .34 && e.variant < .67, s = e.variant >= .67, c = s ? i : 0;
		return {
			...q(480),
	...
	if (e.motion === "jump") {
		let e = G(n / 840), r = e < .16 ? K(e / .16) : 0, i = e >= .16 && e < .76 ? (e - .16) / .6 : 0, a = e >= .76 ? K((e - .76) / .24) : 0;
		return {
			...q(285),
			x: i ? Ht(i) * 2.3 : 0,
	...
	if (e.motion === "duel") {
		let t = G(n / 1050), r = Math.max(0, Math.sin(t * Math.PI * 5));
		return {
			...q(205),
			x: r * (1.8 + e.variant),
	...
	if (e.motion === "near") {
		let t = G(n / 680), r = K(t / .55), i = K((t - .5) / .5);
		return {
			...q(330),
			x: -r * 2.2 + i * 1.2,
			y: -r * (3 + e.variant * 2) + i,
	...
	if (e.motion === "lose") {
		let t = Bt(n).loserReaction, r = n > 920 ? .34 + Math.sin(n * .008 + e.variant * 9) * .08 : 0;
		return {
			...q(520),
			x: -t * 3.5 - r * 1.5,
			y: t * 3.2 + r * 2.2,
...
function qt(e) {
	if (Gt.has(e)) return e;
	let t = Kt[e];
	return t && Gt.has(t) ? t : null;
}
function Jt(e) {
	let t = String(e || ""), n = 0;
	for (let e = 0; e < t.length; e++) n = n * 31 + t.charCodeAt(e) | 0;
	return J[Math.abs(n) % J.length];
}
function Yt(e) {
	return Gt.get(qt(e)) || null;
}
function Xt(e) {
	return Yt(e) || Jt(e);
}
var Zt = "#17191f";
function Qt(e, t) {
	let n = e && typeof e == "object" ? e : {}, r = (e) => typeof e == "string" && e ? e : null;
	return {
		kind: r(n.kind) || "dfl",
		species: r(n.species),
		color: r(n.color) || t || "#2fbf5f",
		accent: r(n.accent) || "#ffffff",
		accessory: r(n.accessory),
...
var Y = (e, t, n, r) => {
	...
	bandana: [...Y(6, 17, 8, 9), ...Y(17, 19, 10, 11)],
	visor: [...Y(7, 17, 4, 5), ...Y(17, 19, 6, 6)],
	crown: [
		...Y(8, 9, 1, 2),
		...Y(12, 13, 1, 2),
		...Y(16, 17, 1, 2),
	...
	focused: []
}, tn = ["none", ...Object.keys($t)], nn = Object.keys(en), rn = (e, t) => e.map((e) => ({
	x: e.x1,
	y: e.y,
	w: e.x2 - e.x1 + 1,
	color: t
...
function X(e, t = 0) {
	let n = e.species || e.color ? e : Qt(e), r = Xt(n.species), i = n.color || "#2fbf5f", a = n.accent || "#ffffff", o = an(Lt(r.px, t), r.palette, i), s = n.accessory ? $t[n.accessory] : void 0;
	s && o.push(...rn(s, a));
	let c = n.expression ? en[n.expression] : void 0;
	return c && o.push(...rn(c, Zt)), {
		width: 24,
		height: 15,
		pose: t,
		runs: o
...
var on = (e) => e.replace(/["<>&]/g, "");
function sn(e) {
	let t = /* @__PURE__ */ new Map();
	for (let n of e) {
		let e = t.get(n.color) || [];
		e.push(`M${n.x} ${n.y}h${n.w}v1h-${n.w}z`), t.set(n.color, e);
	}
	let n = "";
	for (let [e, r] of t) n += `<path fill="${on(e)}" d="${r.join("")}"/>`;
	return n;
}
function cn(e, t) {
	let n = Qt(e, t), r = X(n, 0), i = X(n, 2);
	return `<svg class="racer-art racer-px has-frames" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 15" shape-rendering="crispEdges" aria-hidden="true"><g class="px-frame px-frame-a">${sn(r.runs)}</g><g class="px-frame px-frame-b">${sn(i.runs)}</g></svg>`;
}
function ln() {
	return J.map((e) => e.id);
}
...
function dn(e, t, n) {
	let r = un(e * 131 + t * 977 + n * 7919);
	return {
		x: (r & 65535) / 65535,
		y: (r >>> 16 & 65535) / 65535,
		length: .35 + (un(r + 1) & 65535) / 65535 * .65,
		alpha: .3 + (un(r + 2) & 65535) / 65535 * .7
	};
}
//#endregion
...
function pn(e, t, n, r, i, a, o, s = !1) {
	...
	for (let t = 0; t < 22; t++) {
		let n = dn(Math.floor(a * 100), 404, t), o = n.x * Math.PI * 2, s = 62 + n.y * c * .28, l = r + Math.cos(o) * s, u = i + Math.sin(o) * s;
...
function mn(e) {
	...
	if (u > .05) {
		for (let n = 0; n < (e.reducedMotion ? 2 : 7); n++) {
			let e = -19 + n * 6.5, o = 34 + u * (88 + n * 14) + l * 54, s = Math.sin(r * .02 + n * 1.7 + i * 8) * 1.8;
			t.moveTo(-13, e).lineTo(-13 - o, e + s).stroke({
				color: a,
				width: 9.5 - n * .82,
				alpha: u * (.2 - n * .014),
				cap: "round"
			}), t.moveTo(-16, e).lineTo(-18 - o * .82, e + s * .55).stroke({
				color: n % 3 == 0 ? 16777215 : a,
				width: n % 3 == 0 ? 2.2 : 3.2,
				alpha: u * (.68 - n * .052),
				cap: "round"
			});
		}
		if (n.afterimage > .18) for (let r = 1; r <= (e.reducedMotion ? 1 : 3); r++) {
			let e = -22 - r * (18 + n.afterimage * 13), i = n.afterimage * (.36 - r * .062);
			t.roundRect(e - 15, -18 + r, 24, 32, 7).stroke({
				color: a,
				width: 3.2,
				alpha: i
			}), t.circle(e + 2, -11 + r, 6.5).stroke({
				color: 16777215,
				width: 1.4,
				alpha: i * .8
			});
	...
	if (n.skid > .05 && (t.moveTo(-8, 19).lineTo(-18 - n.skid * 34, 21).stroke({
		...
		let a = Math.floor(r / 58), o = e.reducedMotion ? 3 : n.dust > .62 ? 11 : 7;
		for (let e = 0; e < o; e++) {
			let r = dn(a, Math.floor(i * 17), e), o = 3.2 + r.length * (5.2 + n.dust * 4.4), s = -20 - r.x * (34 + n.dust * 34), c = 15 + r.y * 10 - o * .2;
			t.circle(s, c, o).fill({
				color: e % 4 == 0 ? 16777215 : 14141348,
				alpha: n.dust * r.alpha * (.28 + e % 3 * .075)
			}), e % 3 == 0 && t.circle(s, c, o * 1.35).stroke({
				color: 16115656,
				width: 1,
				alpha: n.dust * r.alpha * .16
			});
		}
		for (let r = 0; r < (e.reducedMotion ? 2 : 6); r++) {
			let e = dn(a, Math.floor(i * 31) + 7, r), o = -16 - e.x * 46, s = 18 + e.y * 7;
			t.moveTo(o, s).lineTo(o - 5 - e.length * 12, s - 2 - e.y * 7).stroke({
				color: r % 2 ? 16761933 : 16777215,
				width: 1.1 + e.length,
				alpha: n.dust * e.alpha * .62
			});
		}
	}
	if (n.impact > .06) {
		let r = 20 + n.impact * 28;
		t.circle(0, 0, r).stroke({
			color: a,
			width: 3.4,
			alpha: n.impact * .62
		}), t.circle(0, 0, r * .62).stroke({
			color: 16777215,
			width: 2,
			alpha: n.impact * .54
		});
		for (let r = 0; r < (e.reducedMotion ? 5 : 14); r++) {
			let e = r / 14 * Math.PI * 2 + i, o = 12 + r % 2 * 4, s = 31 + n.impact * (16 + r % 4 * 5);
			t.moveTo(Math.cos(e) * o, Math.sin(e) * o).lineTo(Math.cos(e) * s, Math.sin(e) * s).stroke({
				color: r % 2 ? a : 16777215,
				width: r % 3 == 0 ? 2.8 : 1.4,
				alpha: n.impact * .72
			});
		}
...
var Z = 3, hn = class {
	...
	#e = new b({ label: "mobile-nameplates" });
	#t = new D({ label: "legacy-feature-set" });
	#n = new rt({
		text: "",
		style: {
			fill: 16777215,
	...
	#r = new D({ label: "background-speed-lines" });
	#i = new D({ label: "winner-focus" });
	#a = new D({ label: "foreground-speed-lines" });
	#o = new D({ label: "photo-finish" });
	#s = new rt({
		text: "",
		style: {
			fill: 16777215,
	...
	async mount(e) {
		this.#c = e, await this.app.init({
			...
			preference: "webgl"
		}), this.app.canvas.className = "arena-pixi-canvas", this.app.canvas.setAttribute("aria-hidden", "true"), e.appendChild(this.app.canvas), this.scenery.addChild(this.#t), this.overlay.addChild(this.#n), this.app.stage.addChild(this.scenery, this.course, this.actors, this.effects, this.overlay), this.course.addChild(this.#r, this.#i), this.effects.addChild(this.#a), this.overlay.addChild(this.#e, this.#o, this.#s), this.#a.blendMode = "add", this.#i.blendMode = "add", this.#o.blendMode = "add", this.#s.anchor.set(.5), this.resize(), typeof ResizeObserver == "function" && (this.#p = new ResizeObserver(() => this.resize()), this.#p.observe(e));
	}
	async setRacers(e) {
		this.#u = e, this.app.canvas.dataset.racerCount = String(e.length), this.#d.clear(), this.actors.removeChildren(), this.#e.removeChildren();
		for (let t of e) {
			let n = new b({ label: `racer-${t.id}` });
			n.eventMode = "none";
			let r = st(t.pet, t.color), i = this.#g(r), a = new b({ label: `pet-${r.species}` });
			a.addChild(...i);
			let o = new D({ label: `effects-${t.id}` }), s = new D({ label: `contact-${t.id}` }).ellipse(0, 23, 27, 6).fill({
				color: 0,
				alpha: .42
			}), c = this.#v(t);
			n.addChild(s, o, a), this.#d.set(t.id, {
				root: n,
				art: a,
				frames: i,
				fx: o,
				nameplate: c,
				color: this.#y(r.accent),
				variant: Wt(t.id, e.indexOf(t)),
				motion: "idle",
				motionStartedMs: 0,
				finishedAtMs: null,
				effectKey: ""
			}), this.actors.addChild(n), this.#e.addChild(c);
		}
	}
	render(e) {
		this.#f = e;
		let t = e.reduceMotionEffects === !0, n = `${Math.floor(e.elapsedMs / 34)}:${e.state}:${e.heat}:${Math.round((e.finish?.camera.mix ?? 0) * 20)}:${t}:${this.#l.width}:${this.#l.height}`;
		n !== this.#m && (this.#m = n, this.#r.clear(), this.#a.clear());
		let r = e.finish?.photoFinish, i = `${r?.phase ?? "none"}:${r?.gapMs ?? 0}:${this.#l.width}:${this.#l.height}:${t}`;
		i !== this.#h && (this.#h = i, fn(this.#o, this.#s, e, this.#l, t)), this.#i.clear();
		let a = 0, o = null;
		for (let n of e.racers) {
			let r = this.#d.get(n.id);
			if (!r) continue;
			let i = e.finish?.celebrationActive === !0, s = i && n.finished && n.id === e.winnerId, c = s ? "win" : i && n.finished ? "lose" : n.exiting ? "run" : n.finished ? "idle" : ct(n.reaction, !1, e.state);
			s && r.finishedAtMs == null && (r.finishedAtMs = e.elapsedMs), n.finished || (r.finishedAtMs = null), r.motion === c ? n.reactionStartedMs != null && (r.motionStartedMs = n.reactionStartedMs) : (r.motion = c, r.motionStartedMs = i ? e.finish?.celebrationStartedMs ?? e.elapsedMs : n.reactionStartedMs ?? r.finishedAtMs ?? e.elapsedMs);
			let l = Ut({
				motion: c,
				elapsedMs: e.elapsedMs,
				motionStartedMs: r.motionStartedMs,
				lane: n.lane,
				heat: e.heat,
				variant: r.variant,
				speed: n.speed ?? 0,
				acceleration: n.acceleration ?? 0,
				reducedMotion: t
			}), u = e.finish?.camera.mix ?? 0, d = n.displayProgress ?? n.progress, f = +!!s, p = f ? this.#l.width * .5 : It(this.#l, d, e.finish?.camera), m = f ? this.#l.height * .5 : Ft(this.#l, n.lane, this.#u.length, u);
			r.root.position.set(p, m);
			let h = 1 + u * (this.#l.compact ? .02 : .08);
			r.root.scale.set(this.#l.actorScale * h * (f ? 1.42 : 1)), r.root.rotation = 0, r.root.alpha = 1, r.art.position.set(l.x, l.y), r.art.scale.set(l.scaleX, l.scaleY), r.art.rotation = l.rotation;
			let g = l.frame;
			r.frames.forEach((e, t) => {
				e.visible = t === g;
			});
			let _ = `${Math.floor(e.elapsedMs / 34)}:${e.heat}:${c}:${t}`;
			_ !== r.effectKey && (r.effectKey = _, mn({
				graphics: r.fx,
				pose: l,
				elapsedMs: e.elapsedMs,
				variant: r.variant,
			...
			s && l.energy > 0 && (o = {
				...
				y: r.root.position.y,
				intensity: l.energy
			}), a = Math.max(a, l.impact);
		}
		o && pn(this.#i, this.#l.width, this.#l.height, o.x, o.y, o.intensity, e.elapsedMs, t);
		let s = (e.finish?.camera.mix ?? 0) * .42;
		a = Math.max(a, s);
		let c = e.state === "running" && !t && e.heat >= 2;
		this.actors.position.set(c ? Math.sin(e.elapsedMs * .09) * a * 1.15 : 0, c ? Math.cos(e.elapsedMs * .11) * a * .7 : 0);
	}
	resize() {
		this.#c && (this.app.resize(), this.#l = Pt(this.app.screen.width, this.app.screen.height), this.app.canvas.dataset.actorWidth = String(Math.round(this.#l.actorScale * 72)), this.#f && this.render(this.#f));
	}
	destroy() {
		this.#p?.disconnect(), this.#p = null, this.#d.clear(), this.#u = [], this.#f = null, this.#m = "", this.#h = "", this.app.destroy(!0, { children: !0 }), this.#c = null;
	}
	#g(e) {
		let t = {
			species: e.species,
	...
	#_(e) {
		let t = new D();
		for (let n of e.runs) t.rect((n.x - e.width / 2) * Z, (n.y - e.height / 2) * Z, n.w * Z, Z).fill(this.#y(n.color));
		return t;
	}
	#v(e) {
		let t = new b({ label: `name-${e.id}` }), n = new rt({
			text: e.name,
			style: {
				fill: 16777215,
...
function gn(e, t, n = !1, r = !1) {
	...
	let i = Math.max(0, Math.min(1, t)), a = n ? .62 : 1, o = 1 - (1 - i) ** 2, s = r ? .26 : 1;
	return {
		blurX: (1.6 + o * 14.2) * a * s,
		blurY: r ? .04 : .12,
		intensity: o * a * (r ? .34 : 1)
	};
}
//#endregion
...
var _n = [
	...
	"near",
	"surge"
], vn = 500, yn = 40, bn = 3.1, xn = [
	300,
	550,
	900
];
function Sn(e) {
	let t = Math.max(1, (Math.max(1, e) - 1) / bn);
	return xn.some((e) => Math.abs(t - e) < 1) || t <= 900 ? vn : Math.min(2e3, Math.round(vn * t / 550));
}
function Cn(e, t, n) {
...
function Tn(e, t) {
	let n = e.officialFinishMs;
	if (n == null || !Number.isFinite(n)) return t;
	let r = Sn(e.samples.length), i = n - r;
	if (e.elapsedMs <= i || e.elapsedMs >= n) return t;
	let a = Math.max(0, Math.min(e.samples.length - 1, Math.floor(i / yn))), o = Math.max(0, Math.min(.999999, e.samples[a] ?? t)), s = Math.max(0, Math.min(1, (e.elapsedMs - i) / r));
	return o + (1 - o) * s;
}
function En(e) {
	let t = Math.max(0, Math.min(e.samples.length - 1, e.lo)), n = Math.max(t, Math.min(e.samples.length - 1, e.hi)), r = Math.max(0, Math.min(1, e.mix)), i = e.samples[t] ?? 0, a = e.samples[n] ?? i, o = e.samples[Math.max(0, t - 1)] ?? i, s = Tn(e, e.elapsedMs <= 0 ? 0 : i + (a - i) * r), c = Math.max(0, Math.min(1, (a - i) * 180)), l = Math.max(-1, Math.min(1, (a - i - (i - o)) * 500)), u = e.officialFinishMs == null ? !!e.finished || s >= 1 : e.elapsedMs >= e.officialFinishMs, d = s, f = u && e.officialFinishMs != null && e.elapsedMs < e.officialFinishMs + 360, p = u ? null : wn(e.timeline, e.lane, e.elapsedMs);
	return {
		id: e.id,
		lane: e.lane,
		progress: s,
...
var Dn = .46, On = .38, kn = .07, An = .26, jn = .85, Mn = .82, Nn = .175, Q = (e) => {
	let t = e <= 0 ? 0 : e >= 1 ? 1 : e;
	return t * t * (3 - 2 * t);
};
function Pn(e) {
	return e >= .07 ? 1 : Q(e / kn);
}
function Fn(e) {
	return e <= 0 ? 0 : e >= 900 ? 1 : Q(e / 900);
}
function In(e) {
	return e >= .26 ? 1 : Q(e / An);
}
function Ln(e) {
	let t = (e, t) => e * Math.tanh(Math.max(0, t) / e), n = Math.max(0, Math.min(1, (e - Mn) / .18000000000000005)), r = jn + -.6699999999999999 * (n * n * (3 - 2 * n));
	return {
		ahead: t(Dn, (1 - e) * r),
		behind: t(On, e * .9)
	};
...
function Bn(e, t, n) {
	let r = Rn((t >>> 0 ^ 1374496513) >>> 0), i = Array.from({ length: n }, () => []), a = e.samples[0];
	if (!a) return i;
	let o = (t) => {
		let r = 0;
		for (; r < e.frames && (a[r] ?? 0) < t;) r++;
		return Array.from({ length: n }, (e, t) => t).sort((t, n) => (e.samples[n]?.[r] ?? 0) - (e.samples[t]?.[r] ?? 0));
	}, s = (e, t, n) => i[e].some((e) => t < e.start + e.width && e.start < t + n), c = n <= 4 ? n : Math.round(n * 1.7);
	for (let e = 0; e < c; e++) {
		let e = [
			"breakaway",
			"collapse",
			"comeback",
			"latecharge"
		][Math.floor(r() * 4)], t = e === "collapse", a = t ? .28 + r() * .2 : .18 + r() * .22, c = e === "latecharge" ? .56 + r() * .16 : .08 + r() * .5, l = o(c), u;
		if (u = e === "breakaway" ? l[Math.floor(r() * Math.min(3, n))] : e === "collapse" ? l[Math.floor(r() * Math.min(4, n))] : l[n - 1 - Math.floor(r() * Math.min(4, n))], s(u, c, a)) continue;
		let d = t, f = (d ? -1 : 1) * (d ? .2 + r() * .16 : .13 + r() * .13);
		if (i[u].push({
			kind: e,
			racer: u,
			start: c,
			...
			let e = c + a * .96, t = Math.min(.36, Math.max(.26, a));
			e + t < .99 && !s(u, e, t) && i[u].push({
				kind: "comeback",
				racer: u,
				start: e,
				width: t,
...
function Hn(e, t) {
	...
	let i = Rn((t >>> 0 ^ 2654435769) >>> 0), a = Array.from({ length: n }, () => ({
		a1: .6 + i() * .55,
		f1: 1.3 + i() * 1.6,
		p1: i() * Math.PI * 2,
		a2: .22 + i() * .3,
		...
		p2: i() * Math.PI * 2,
		amp: .45 + i() * 1.5
	})), o = Bn(e, t, n), s = Array.from({ length: n }, () => new Float32Array(r + 1)), c = [], l = /* @__PURE__ */ new Set(), u = new Map(e.order.map((e) => [e.index, e.finishMs]));
	for (let t = 0; t < n; t++) {
		...
		for (let e = 0; e <= r; e++) {
			...
			for (let n of d) {
				p += n.power * zn((r - n.start) / n.width, n.hold);
			...
			let m = Pn(r) * Fn(f - e * 40) * In(r), h = (u * n.amp * Nn * a + p) * m, { ahead: g, behind: _ } = Ln(r), v = h >= 0 ? g : _, y = v > 1e-6 ? v * Math.tanh(h / v) : 0, b = r * Pn(r) + y;
			b < 0 && (b = 0), r < 1 && b > r + g && (b = r + g), r >= 1 && (b = 1), s[t][e] = b;
		}
	}
	return c.sort((e, t) => e.ms - t.ms), {
		shown: s,
		events: c,
		arcs: o
	};
...
function Gn(e) {
	...
	for (let r of e.order) {
		let i = Math.max(1e-6, t[r.index] ?? 1e-4), a = Un(r.place, e.order.length), o = a / i;
		n[r.index] = {
			finishMs: r.finishMs,
			place: r.place,
			crossSpeed: i,
...
function Yn(e, t, n, r) {
	let i = Jn(t, n, r);
	if (e.phase = i, e.displayProgress = qn(e.progress, t, n), e.exiting = i === "crossing" || i === "coasting", e.exiting && n) {
		let r = t - n.finishMs;
		e.speed = Math.max(0, Math.min(1, n.crossSpeed * Kn(r) * 40 * 180));
	}
	return e;
}
//#endregion
...
//#endregion
export { tn as ACCESSORY_KEYS, nn as EXPRESSION_KEYS, Nt as LANE_BAND_BOTTOM, Mt as LANE_BAND_TOP, On as MAX_DROP, Dn as MAX_LEAD, Ln as allowance, zn as arcShape, gn as backgroundMotion, ln as characterIds, cn as characterSvg, Fn as closingEase, qn as coastProgress, X as composeCharacter, Xn as createArenaRenderer, jt as createFinishPresentation, Cn as createReactionTimeline, Vn as crossingSpeeds, Hn as dramatize, pt as finishArrival, Jn as finishPhase, gt as finishSettledMs, Gn as finishTrajectories, Pn as launchEase, Qt as normalizeCharacter, In as openEase, Bn as planArcs, Yn as presentFinish, En as presentationRacerFrame, Tt as presentationScreenRatio, wn as reactionAt, sn as runsToPaths, Un as settleOffset, an as silhouetteRuns };
