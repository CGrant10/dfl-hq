import { B as e, P as t, a as n, b as r, c as i, o as a, s as o, t as s, u as c, v as l, x as u, z as d } from "./Geometry-BuU6bpP9.js";
import { t as f, u as p } from "./Filter-N7Ki-nhd.js";
import { t as m } from "./getPo2TextureFromSource-CZ557Jpw.js";
import { t as h } from "./canvasUtils-Cdp1yAfY.js";
import { t as g } from "./CanvasPool-BzNdDEgL.js";
...
var D = new s({
	...
	generateFilteredTexture({ texture: e, filters: t }) {
		...
		let s = i;
		this._calculateGlobalFrame(n, 0, 0, s, r.width, r.height), n.outputRenderSurface = p.getOptimalTexture(o.width, o.height, n.resolution, n.antialias), n.backTexture = u.EMPTY, n.inputTexture = e, this.renderer.renderTarget.finishRenderPass(), this._applyFiltersToTexture(n, !0);
	...
	_setupFilterTextures(e, t, n, r) {
		if (e.backTexture = u.EMPTY, e.inputTexture = p.getOptimalTexture(t.width, t.height, e.resolution, e.antialias), e.blendRequired) {
...
//# sourceMappingURL=init-DfPSPYrB.js.map
