...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, n) => {
...
}, f = (e, t) => d(e).priority ?? t, p = {
	_addHandlers: {},
	_removeHandlers: {},
	_queue: {},
	remove(...e) {
		return e.map(d).forEach((e) => {
	...
	handleByNamedList(e, t, n = -1) {
		return this.handle(e, (e) => {
			t.findIndex((t) => t.name === e.name) >= 0 || (t.push({
				name: e.name,
				value: e.ref
			}), t.sort((e, t) => f(t.value, n) - f(e.value, n)));
		}, (e) => {
	...
	handleByList(e, t, n = -1) {
		return this.handle(e, (e) => {
			t.includes(e.ref) || (t.push(e.ref), t.sort((e, t) => f(t, n) - f(e, n)));
		}, (e) => {
...
})))(), 1)).default, g = Math.PI * 2, _ = 180 / Math.PI, v = Math.PI / 180, y = class e {
	constructor(e = 0, t = 0) {
...
function ie() {
	for (let e = 0; e < 16; e++) {
		...
		ne.push(t);
		for (let n = 0; n < 16; n++) {
			let r = E(S[e] * S[n] + w[e] * C[n]), i = E(C[e] * S[n] + T[e] * C[n]), a = E(S[e] * w[n] + w[e] * T[n]), o = E(C[e] * w[n] + T[e] * T[n]);
			for (let e = 0; e < 16; e++) if (S[e] === r && C[e] === i && w[e] === a && T[e] === o) {
				t.push(e);
				break;
			}
		}
	...
	for (let e = 0; e < 16; e++) {
		let t = new x();
		t.set(S[e], C[e], w[e], T[e], 0, 0), re.push(t);
	}
}
ie();
var D = {
	...
	inv: (e) => e & 8 ? e & 15 : -e & 7,
	add: (e, t) => ne[e][t],
	sub: (e, t) => ne[e][D.inv(t)],
	rotate180: (e) => e ^ 4,
	isVertical: (e) => (e & 3) == 2,
	byDirection: (e, t) => Math.abs(e) * 2 <= Math.abs(t) ? t >= 0 ? D.S : D.N : Math.abs(t) * 2 <= Math.abs(e) ? e > 0 ? D.E : D.W : t > 0 ? e > 0 ? D.SE : D.SW : e > 0 ? D.NE : D.NW,
	matrixAppendRotationInv: (e, t, n = 0, r = 0, i = 0, a = 0) => {
		let o = re[D.inv(t)], s = o.a, c = o.b, l = o.c, u = o.d, d = n - Math.min(0, s * i, l * a, s * i + l * a), f = r - Math.min(0, c * i, u * a, c * i + u * a), p = e.a, m = e.b, h = e.c, g = e.d;
	...
	transformRectCoords: (e, t, n, r) => {
		...
		return n === D.E ? (r.set(i + c, a + l, o, s), r) : n === D.S ? r.set(u - a - s + c, i + l, s, o) : n === D.W ? r.set(u - i - o + c, d - a - s + l, o, s) : n === D.N ? r.set(a + c, d - i - o + l, s, o) : r.set(i + c, a + l, o, s);
	}
}, O = [
	new y(),
	new y(),
	...
	intersects(e, t) {
		...
		if (r <= n || a <= i) return !1;
		let o = O[0].set(e.left, e.top), s = O[1].set(e.left, e.bottom), c = O[2].set(e.right, e.top), l = O[3].set(e.right, e.bottom);
...
function k(e = "default") {
	return oe[e] === void 0 && (oe[e] = -1), ++oe[e];
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/utils/logging/deprecation.mjs
var se = /* @__PURE__ */ new Set(), A = "8.0.0", ce = "8.3.4", j = {
	quiet: !1,
	noColor: !1
}, M = ((e, t, n = 3) => {
	if (j.quiet || se.has(t)) return;
	let r = (/* @__PURE__ */ Error()).stack, i = `${t}
Deprecated since v${e}`, a = typeof console.groupCollapsed == "function" && !j.noColor;
	r === void 0 ? console.warn("PixiJS Deprecation Warning: ", i) : (r = r.split("\n").splice(n).join("\n"), a ? (console.groupCollapsed("%cPixiJS Deprecation Warning: %c%s", "color:#614108;background:#fffbe6", "font-weight:normal;color:#614108;background:#fffbe6", i), console.warn(r), console.groupEnd()) : (console.warn("PixiJS Deprecation Warning: ", i), console.warn(r))), se.add(t);
});
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/utils/misc/NOOP.mjs
var le = () => {};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/maths/misc/pow2.mjs
function ue(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/utils/definedProps.mjs
function fe(e) {
	let t = {};
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/texture/TextureStyle.mjs
var pe = /* @__PURE__ */ Object.create(null);
function me(e) {
	let t = pe[e];
	return t === void 0 && (pe[e] = k("resource")), t;
}
var he = class e extends h {
	constructor(t = {}) {
	...
	set wrapMode(e) {
		M(A, "TextureStyle.wrapMode is now TextureStyle.addressMode"), this.addressMode = e;
	}
	get wrapMode() {
	...
	_generateResourceId() {
		...
		return this._sharedResourceId = me(e), this._resourceId;
	}
	destroy() {
...
var ge = he, _e = class e extends h {
	...
	resize(e, t, n) {
		...
		return this.width = r / n, this.height = i / n, this._resolution = n, this.pixelWidth === r && this.pixelHeight === i ? !1 : (this._refreshPOT(), this.pixelWidth = r, this.pixelHeight = i, this.emit("resize", this), this._resourceId = k("resource"), this.emit("change", this), !0);
	}
	updateMipmaps() {
	...
	_refreshPOT() {
		this.isPowerOfTwo = de(this.pixelWidth) && de(this.pixelHeight);
	}
	static test(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/texture/TextureMatrix.mjs
var ye = new x(), be = class {
	constructor(e, t) {
		this.mapCoord = new x(), this.uClampFrame = /* @__PURE__ */ new Float32Array(4), this.uClampOffset = /* @__PURE__ */ new Float32Array(2), this._updateID = 0, this.clampOffset = 0, this.clampMargin = t === void 0 ? e.width < 10 ? 0 : .5 : t, this.isSimple = !1, this.texture = e;
	}
	get texture() {
	...
	update() {
		...
		r && (ye.set(n.width / r.width, 0, 0, n.height / r.height, -r.x / r.width, -r.y / r.height), this.mapCoord.append(ye));
	...
	constructor({ source: e, label: t, frame: n, orig: r, trim: i, defaultAnchor: a, defaultBorders: o, rotate: s, dynamic: c } = {}) {
		if (super(), this.uid = k("texture"), this.uvs = {
			...
			x3: 0,
			y3: 0
		}, this.frame = new ae(), this.noFrame = !1, this.dynamic = !1, this.isTexture = !0, this.label = t, this.source = e?.source ?? new N(), this.noFrame = !n, n) this.frame.copyFrom(n);
		else {
	...
	get textureMatrix() {
		return this._textureMatrix ||= new be(this), this._textureMatrix;
	}
	get width() {
	...
	updateUvs() {
		...
		if (c) {
			...
			c = D.add(c, D.NW), e.x0 = r + t * D.uX(c), e.y0 = l + n * D.uY(c), c = D.add(c, 2), e.x1 = r + t * D.uX(c), e.y1 = l + n * D.uY(c), c = D.add(c, 2), e.x2 = r + t * D.uX(c), e.y2 = l + n * D.uY(c), c = D.add(c, 2), e.x3 = r + t * D.uX(c), e.y3 = l + n * D.uY(c);
	...
	get baseTexture() {
		return M(A, "Texture.baseTexture is now Texture.source"), this._source;
	}
};
P.EMPTY = new P({
	label: "EMPTY",
	source: new N({ label: "EMPTY" })
}), P.EMPTY.destroy = le, P.WHITE = new P({
	source: new ve({
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/utils/data/updateQuadBounds.mjs
function xe(e, t, n) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/bounds/Bounds.mjs
var Se = new x(), F = class e {
	constructor(e = Infinity, t = Infinity, n = -Infinity, r = -Infinity) {
		this.minX = Infinity, this.minY = Infinity, this.maxX = -Infinity, this.maxY = -Infinity, this.matrix = Se, this.minX = e, this.minY = t, this.maxX = n, this.maxY = r;
	}
	isEmpty() {
		return this.minX > this.maxX || this.minY > this.maxY;
	}
	get rectangle() {
		this._rectangle ||= new ae();
	...
	clear() {
		return this.minX = Infinity, this.minY = Infinity, this.maxX = -Infinity, this.maxY = -Infinity, this.matrix = Se, this;
	}
	set(e, t, n, r) {
	...
	var t, n, r, i;
}, Ne = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Pe = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Fe = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Ie = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Le = {
	string: [
		[function(e) {
			var t = De.exec(e);
		...
		[function(e) {
			var t = Fe.exec(e) || Ie.exec(e);
			return t ? t[2] !== t[4] || t[4] !== t[6] ? null : Te({
		...
		[function(e) {
			var t = Ne.exec(e) || Pe.exec(e);
			if (!t) return null;
			var n, r;
			return Me(Ae({
				h: (n = t[1], r = t[2], r === void 0 && (r = "deg"), Number(n) * (Ce[r] || 1)),
				s: Number(t[3]),
				l: Number(t[4]),
	...
	object: [
		...
		[function(e) {
			...
			return !I(t) || !I(n) || !I(r) ? null : ke(function(e) {
				return {
					h: we(e.h),
					s: R(e.s, 0, 100),
					v: R(e.v, 0, 100),
	...
	return typeof e == "string" ? Re(e.trim(), Le.string) : typeof e == "object" && e ? Re(e, Le.object) : [null, void 0];
}, Be = function(e, t) {
	var n = B(e);
	return {
		h: n.h,
	...
	return e.prototype.isValid = function() {
		...
		return L(Ve(this.rgba), 2);
	}, e.prototype.isDark = function() {
		return Ve(this.rgba) < .5;
	}, e.prototype.isLight = function() {
		return Ve(this.rgba) >= .5;
	}, e.prototype.toHex = function() {
		return e = Ee(this.rgba), t = e.r, n = e.g, r = e.b, a = (i = e.a) < 1 ? z(L(255 * i)) : "", "#" + z(t) + z(n) + z(r) + a;
		var e, t, n, r, i, a;
	}, e.prototype.toRgb = function() {
		return Ee(this.rgba);
	}, e.prototype.toRgbString = function() {
		return e = Ee(this.rgba), t = e.r, n = e.g, r = e.b, (i = e.a) < 1 ? "rgba(" + t + ", " + n + ", " + r + ", " + i + ")" : "rgb(" + t + ", " + n + ", " + r + ")";
		var e, t, n, r, i;
	}, e.prototype.toHsl = function() {
		return je(B(this.rgba));
	}, e.prototype.toHslString = function() {
		return e = je(B(this.rgba)), t = e.h, n = e.s, r = e.l, (i = e.a) < 1 ? "hsla(" + t + ", " + n + "%, " + r + "%, " + i + ")" : "hsl(" + t + ", " + n + "%, " + r + "%)";
		var e, t, n, r, i;
	}, e.prototype.toHsv = function() {
		return e = Oe(this.rgba), {
			h: L(e.h),
			s: L(e.s),
			v: L(e.v),
			a: L(e.a, 3)
		...
		return e === void 0 && (e = .1), V(Be(this.rgba, e));
	}, e.prototype.desaturate = function(e) {
		return e === void 0 && (e = .1), V(Be(this.rgba, -e));
	}, e.prototype.grayscale = function() {
		return V(Be(this.rgba, -1));
	}, e.prototype.lighten = function(e) {
		return e === void 0 && (e = .1), V(He(this.rgba, e));
	...
	return e instanceof Ue ? e : new Ue(e);
}, We = [], Ge = function(e) {
	e.forEach(function(e) {
		We.indexOf(e) < 0 && (e(Ue, Le), We.push(e));
	});
};
//#endregion
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/color/Color.mjs
Ge([Ke]);
var H = class e {
...
H.shared = new H(), H._temp = new H(), H.HEX_PATTERN = /^(#|0x)?(([a-f0-9]{3}){1,2}([a-f0-9]{2})?)$/i;
var qe = H, Je = {
	cullArea: null,
	cullable: !1,
	cullableChildren: !0
...
function Ze(...e) {
	Ye !== Xe && (Ye++, Ye === Xe ? console.warn("PixiJS Warning: too many warnings, no more warnings will be reported to the console by PixiJS.") : console.warn("PixiJS Warning: ", ...e));
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/utils/pool/GlobalResourceRegistry.mjs
var Qe = {
	...
	getPool(e) {
		return this._poolsByClass.has(e) || this._poolsByClass.set(e, new $e(e)), this._poolsByClass.get(e);
	}
	stats() {
		let e = {};
...
Qe.register(U);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/container-mixins/cacheAsTextureMixin.mjs
var et = {
	...
	set cacheAsBitmap(e) {
		M("v8.6.0", "cacheAsBitmap is deprecated, use cacheAsTexture instead."), this.cacheAsTexture(e);
	}
};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/utils/data/removeItems.mjs
function tt(e, t, n) {
	let r = e.length, i;
	if (t >= r || n === 0) return;
	n = t + n > r ? r - t : n;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/container-mixins/childrenHelperMixin.mjs
var nt = {
	allowChildren: !0,
	...
	addChildAt(e, t) {
		this.allowChildren || M(A, "addChildAt: Only Containers will be allowed to add children in v8.0.0");
		let { children: n } = this;
	...
	getMaskEffect(e) {
		...
		for (let t = 0; t < this._tests.length; t++) {
			let n = this._tests[t];
			if (n.test(e)) return U.get(n.maskClass, e);
		}
		return e;
	}
	returnMaskEffect(e) {
...
p.handleByList(u.MaskEffect, at._effectClasses);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/container-mixins/effectsMixin.mjs
var ot = {
	_maskEffect: null,
	_maskOptions: {
		inverse: !1,
	...
	set mask(e) {
		...
		t?.mask !== e && (t && (this.removeEffect(t), at.returnMaskEffect(t), this._maskEffect = null), e != null && (this._maskEffect = at.getMaskEffect(e), this.addEffect(this._maskEffect)));
	},
	get mask() {
	...
	set filters(e) {
		...
		let t = this._filterEffect ||= new it();
		e = e;
	...
	set filterArea(e) {
		this._filterEffect ||= new it(), this._filterEffect.filterArea = e;
	},
	get filterArea() {
	...
	label: null,
	get name() {
		return M(A, "Container.name property has been removed, use Container.label instead"), this.label;
	},
	set name(e) {
		M(A, "Container.name property has been removed, use Container.label instead"), this.label = e;
	},
...
}, W = U.getPool(x), G = U.getPool(F), ct = new x(), lt = {
	getFastGlobalBounds(e, t) {
		t ||= new F(), t.clear(), this._getGlobalBoundsRecursive(!!e, t, this.parentRenderLayer), t.isValid || t.set(0, 0, 0, 0);
	...
	_getGlobalBoundsRecursive(e, t, n) {
		...
		if ((this.renderGroup || i) && (r = G.get().clear()), this.boundsArea) t.addRect(this.boundsArea, this.worldTransform);
		else {
		...
		if (i) {
			...
			e && r.applyMatrix(n.worldTransform.copyTo(ct).invert()), t.addBounds(r), G.return(r);
		} else this.renderGroup && (t.addBounds(r, this.relativeGroupTransform), G.return(r));
	}
};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/bounds/getGlobalBounds.mjs
function ut(e, t, n) {
	n.clear();
	let r, i;
	return e.parent ? t ? r = e.parent.worldTransform : (i = W.get().identity(), r = ft(e, i)) : r = x.IDENTITY, dt(e, n, r, t), i && W.return(i), n.isValid || n.set(0, 0, 0, 0), n;
}
function dt(e, t, n, r) {
	if (!e.visible || !e.measurable) return;
	let i;
	r ? i = e.worldTransform : (e.updateLocalTransform(), i = W.get(), i.appendFrom(e.localTransform, n));
	let a = t, o = !!e.effects.length;
	if (o && (t = G.get().clear()), e.boundsArea) t.addRect(e.boundsArea, i);
	else {
		let n = e.bounds;
		n && !n.isEmpty() && (t.matrix = i, t.addBounds(n));
		for (let n = 0; n < e.children.length; n++) dt(e.children[n], t, i, r);
	}
	if (o) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addBounds?.(t);
		a.addBounds(t, x.IDENTITY), G.return(t);
	}
	r || W.return(i);
}
function ft(e, t) {
	let n = e.parent;
	return n && (ft(n, t), n.updateLocalTransform(), t.append(n.localTransform)), t;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/utils/multiplyHexColors.mjs
function pt(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/utils/multiplyColors.mjs
var mt = 16777215;
function ht(e, t) {
	return e === mt ? t : t === mt ? e : pt(e, t);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/container-mixins/getGlobalMixin.mjs
function K(e) {
...
var gt = {
	...
	getGlobalTransform(e = new x(), t) {
		if (t) return e.copyFrom(this.worldTransform);
		this.updateLocalTransform();
		let n = ft(this, W.get().identity());
		return e.appendFrom(this.localTransform, n), W.return(n), e;
	},
	getGlobalTint(e) {
		if (e) return this.renderGroup ? K(this.renderGroup.worldColor) : this.parentRenderGroup ? K(ht(this.localColor, this.parentRenderGroup.worldColor)) : this.tint;
		let t = this.localColor, n = this.parent;
		for (; n;) t = ht(t, n.localColor), n = n.parent;
		return K(t);
	}
};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/bounds/getLocalBounds.mjs
function _t(e, t, n) {
	return t.clear(), n ||= x.IDENTITY, vt(e, t, n, e, !0), t.isValid || t.set(0, 0, 0, 0), t;
}
function vt(e, t, n, r, i) {
	let a;
	if (i) a = W.get(), a = n.copyTo(a);
	else {
		if (!e.visible || !e.measurable) return;
		e.updateLocalTransform();
		let t = e.localTransform;
		a = W.get(), a.appendFrom(t, n);
	}
	let o = t, s = !!e.effects.length;
	if (s && (t = G.get().clear()), e.boundsArea) t.addRect(e.boundsArea, a);
	else {
		e.renderPipeId && (t.matrix = a, t.addBounds(e.bounds));
		let n = e.children;
		for (let e = 0; e < n.length; e++) vt(n[e], t, a, r, !1);
	}
	if (s) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addLocalBounds?.(t, r);
		o.addBounds(t, x.IDENTITY), G.return(t);
	}
	W.return(a);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/utils/checkChildrenDidChange.mjs
function yt(e, t) {
	let n = e.children;
	for (let e = 0; e < n.length; e++) {
		let r = n[e], i = r.uid, a = (r._didViewChangeTick & 65535) << 16 | r._didContainerChangeTick & 65535, o = t.index;
		(t.data[o] !== i || t.data[o + 1] !== a) && (t.data[t.index] = i, t.data[t.index + 1] = a, t.didChange = !0), t.index = o + 2, r.children.length && yt(r, t);
	}
	return t.didChange;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/container-mixins/measureMixin.mjs
var bt = new x(), xt = {
	...
	getLocalBounds() {
		...
		return e.index = 1, e.didChange = !1, e.data[0] !== this._didViewChangeTick && (e.didChange = !0, e.data[0] = this._didViewChangeTick), yt(this, e), e.didChange && _t(this, e.localBounds, bt), e.localBounds;
	},
	getBounds(e, t) {
		return ut(this, e, t || new F());
	}
}, St = {
	_onRender: null,
	set onRender(e) {
	...
	sortChildren() {
		this.sortDirty && (this.sortDirty = !1, this.children.sort(wt));
	}
};
function wt(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/container-mixins/toLocalGlobalMixin.mjs
var Tt = {
	getGlobalPosition(e = new y(), t = !1) {
		return this.parent ? this.parent.toGlobal(this._position, e, t) : (e.x = this._position.x, e.y = this._position.y), e;
	},
	toGlobal(e, t, n = !1) {
		let r = this.getGlobalTransform(W.get(), n);
		return t = r.apply(e, t), W.return(r), t;
	},
	toLocal(e, t, n, r) {
		t && (e = t.toGlobal(e, n, r));
		let i = this.getGlobalTransform(W.get(), r);
		return n = i.applyInverse(e, n), W.return(i), n;
	}
}, Et = class {
	constructor() {
	...
	constructor(e) {
		this._poolKeyHash = /* @__PURE__ */ Object.create(null), this._texturePool = {}, this.textureOptions = e || {}, this.enableFullScreen = !1, this.textureStyle = new ge(this.textureOptions);
	}
...
Qe.register(Ot);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/RenderGroup.mjs
var kt = class {
	constructor() {
		this.renderPipeId = "renderGroup", this.root = null, this.canBundle = !1, this.renderGroupParent = null, this.renderGroupChildren = [], this.worldTransform = new x(), this.worldColorAlpha = 4294967295, this.worldColor = 16777215, this.worldAlpha = 1, this.childrenToUpdate = /* @__PURE__ */ Object.create(null), this.updateTick = 0, this.gcTick = 0, this.childrenRenderablesToUpdate = {
			list: [],
			index: 0
		}, this.structureDidChange = !0, this.instructionSet = new Et(), this._onRenderContainers = [], this.textureNeedsUpdate = !0, this.isCachedAsTexture = !1, this._matrixDirty = 7;
	}
	init(e) {
	...
	disableCacheAsTexture() {
		this.isCachedAsTexture = !1, this.texture &&= (Ot.returnTexture(this.texture, !0), null);
	}
	updateCacheTexture() {
	...
	get inverseWorldTransform() {
		return this._matrixDirty & 1 ? (this._matrixDirty &= -2, this._inverseWorldTransform ||= new x(), this._inverseWorldTransform.copyFrom(this.worldTransform).invert()) : this._inverseWorldTransform;
	}
	get textureOffsetInverseTransform() {
		return this._matrixDirty & 2 ? (this._matrixDirty &= -3, this._textureOffsetInverseTransform ||= new x(), this._textureOffsetInverseTransform.copyFrom(this.inverseWorldTransform).translate(-this._textureBounds.x, -this._textureBounds.y)) : this._textureOffsetInverseTransform;
	}
	get inverseParentTextureTransform() {
		if (!(this._matrixDirty & 4)) return this._inverseParentTextureTransform;
		this._matrixDirty &= -5;
		let e = this._parentCacheAsTextureRenderGroup;
		return e ? (this._inverseParentTextureTransform ||= new x(), this._inverseParentTextureTransform.copyFrom(this.worldTransform).prepend(e.inverseWorldTransform).translate(-e._textureBounds.x, -e._textureBounds.y)) : this.worldTransform;
	}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/utils/assignWithIgnore.mjs
function At(e, t, n = {}) {
	for (let r in t) !n[r] && t[r] !== void 0 && (e[r] = t[r]);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/container/Container.mjs
var jt = new m(null), q = new m(null), Mt = new m(null, 1, 1), J = new m(null), Nt = class e extends h {
	constructor(e = {}) {
		super(), this.uid = k("renderable"), this._updateFlags = 15, this.renderGroup = null, this.parentRenderGroup = null, this.parentRenderGroupIndex = 0, this.didChange = !1, this.didViewUpdate = !1, this.relativeRenderGroupDepth = 0, this.children = [], this.parent = null, this.includeInBuild = !0, this.measurable = !0, this.isSimple = !0, this.parentRenderLayer = null, this.updateTick = -1, this.localTransform = new x(), this.relativeGroupTransform = new x(), this.groupTransform = this.relativeGroupTransform, this.destroyed = !1, this._position = new m(this, 0, 0), this._scale = Mt, this._pivot = q, this._origin = J, this._skew = jt, this._cx = 1, this._sx = 0, this._cy = 0, this._sy = 1, this._rotation = 0, this.localColor = 16777215, this.localAlpha = 1, this.groupAlpha = 1, this.groupColor = 16777215, this.groupColorAlpha = 4294967295, this.localBlendMode = "inherit", this.groupBlendMode = "normal", this.localDisplayStatus = 7, this.globalDisplayStatus = 7, this._didContainerChangeTick = 0, this._didViewChangeTick = 0, this._didLocalTransformChangeId = -1, this.effects = [], At(this, e, {
			children: !0,
			parent: !0,
			effects: !0
	...
	static mixin(t) {
		M("8.8.0", "Container.mixin is deprecated, please use extensions.mixin instead."), p.mixin(e, t);
	}
	set _didChangeId(e) {
	...
	addChild(...e) {
		if (this.allowChildren || M(A, "addChild: Only Containers will be allowed to add children in v8.0.0"), e.length > 1) {
	...
	enableRenderGroup() {
		...
		e?.removeChild(this), this.renderGroup = U.get(kt, this), this.groupTransform = x.IDENTITY, e?.addChild(this), this._updateIsSimple();
	}
	disableRenderGroup() {
		if (!this.renderGroup) return;
		let e = this.parentRenderGroup;
		e?.removeChild(this), U.return(this.renderGroup), this.renderGroup = null, this.groupTransform = this.relativeGroupTransform, e?.addChild(this), this._updateIsSimple();
	}
	_updateIsSimple() {
		this.isSimple = !this.renderGroup && this.effects.length === 0;
	}
	get worldTransform() {
		return this._worldTransform ||= new x(), this.renderGroup ? this._worldTransform.copyFrom(this.renderGroup.worldTransform) : this.parentRenderGroup && this._worldTransform.appendFrom(this.relativeGroupTransform, this.parentRenderGroup.worldTransform), this._worldTransform;
	}
	get x() {
	...
	get angle() {
		return this.rotation * _;
	}
	set angle(e) {
		this.rotation = e * v;
	}
	get pivot() {
		return this._pivot === q && (this._pivot = new m(this, 0, 0)), this._pivot;
	}
	set pivot(e) {
		this._pivot === q && (this._pivot = new m(this, 0, 0), this._origin !== J && Ze("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._pivot.set(e) : this._pivot.copyFrom(e);
	}
	get skew() {
		return this._skew === jt && (this._skew = new m(this, 0, 0)), this._skew;
	}
	set skew(e) {
		this._skew === jt && (this._skew = new m(this, 0, 0)), this._skew.copyFrom(e);
	}
	get scale() {
		return this._scale === Mt && (this._scale = new m(this, 1, 1)), this._scale;
	}
	set scale(e) {
		this._scale === Mt && (this._scale = new m(this, 0, 0)), typeof e == "string" && (e = parseFloat(e)), typeof e == "number" ? this._scale.set(e) : this._scale.copyFrom(e);
	}
	get origin() {
		return this._origin === J && (this._origin = new m(this, 0, 0)), this._origin;
	}
	set origin(e) {
		this._origin === J && (this._origin = new m(this, 0, 0), this._pivot !== q && Ze("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._origin.set(e) : this._origin.copyFrom(e);
	}
	get width() {
	...
	set tint(e) {
		let t = qe.shared.setValue(e ?? 16777215).toBgrNumber();
...
p.mixin(Nt, nt, lt, Tt, St, xt, ot, st, Ct, Je, et, gt, rt);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/view/ViewContainer.mjs
var Pt = class extends Nt {
	constructor(e) {
		super(e), this.canBundle = !0, this.allowChildren = !1, this._roundPixels = 0, this._lastUsed = -1, this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this._bounds = new F(0, 1, 0, 0), this._boundsDirty = !0, this.autoGarbageCollect = e.autoGarbageCollect ?? !0;
	}
	get bounds() {
	...
	get visualBounds() {
		return xe(this._visualBounds, this._anchor, this._texture), this._visualBounds;
	}
	get sourceBounds() {
		return M("8.6.1", "Sprite.sourceBounds is deprecated, use visualBounds instead."), this.visualBounds;
	}
	updateBounds() {
	...
	constructor(e) {
		e.resource ||= Lt.get().createCanvas(), e.width || (e.width = e.resource.width, e.autoDensity || (e.width /= e.resolution)), e.height || (e.height = e.resource.height, e.autoDensity || (e.height /= e.resolution)), super(e), this.uploadMethodId = "image", this.autoDensity = e.autoDensity, this.resizeCanvas(), this.transparent = !!e.transparent;
	}
	resizeCanvas() {
...
Rt.extension = u.TextureSource;
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/ticker/const.mjs
var zt = /* @__PURE__ */ ((e) => (e[e.INTERACTION = 50] = "INTERACTION", e[e.HIGH = 25] = "HIGH", e[e.NORMAL = 0] = "NORMAL", e[e.LOW = -25] = "LOW", e[e.UTILITY = -50] = "UTILITY", e))(zt || {}), Bt = class {
	...
	constructor() {
		this.autoStart = !1, this.deltaTime = 1, this.lastTime = -1, this.speed = 1, this.started = !1, this._requestId = null, this._maxElapsedMS = 100, this._minElapsedMS = 0, this._protected = !1, this._lastFrame = -1, this._head = new Bt(null, null, Infinity), this.deltaMS = 1 / e.targetFPMS, this.elapsedMS = 1 / e.targetFPMS, this._tick = (e) => {
	...
	add(e, t, n = zt.NORMAL) {
		return this._addListener(new Bt(e, t, n));
	}
	addOnce(e, t, n = zt.NORMAL) {
		return this._addListener(new Bt(e, t, n, !0));
	}
	_addListener(e) {
...
Vt.targetFPMS = .06;
var Ht = Vt, Ut = /* @__PURE__ */ Object.create(null), Wt = /* @__PURE__ */ Object.create(null);
function Gt(e, t) {
	let n = Wt[e];
	return n === void 0 && (Ut[t] === void 0 && (Ut[t] = 1), Wt[e] = n = Ut[t]++), n;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/getTestContext.mjs
var Kt;
function qt() {
	return (!Kt || Kt?.isContextLost()) && (Kt = Lt.get().createCanvas().getContext("webgl", {})), Kt;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/getMaxFragmentPrecision.mjs
var Jt;
function Yt() {
	if (!Jt) {
		Jt = "mediump";
		let e = qt();
		e && e.getShaderPrecisionFormat && (Jt = e.getShaderPrecisionFormat(e.FRAGMENT_SHADER, e.HIGH_FLOAT).precision ? "highp" : "mediump");
	}
	return Jt;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/addProgramDefines.mjs
function Xt(e, t, n) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/ensurePrecision.mjs
function Zt(e, t, n) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/insertVersion.mjs
function Qt(e, t) {
	return t ? `#version 300 es
${e}` : e;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/setProgramName.mjs
var $t = {}, en = {};
function tn(e, { name: t = "pixi-program" }, n = !0) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/stripVersion.mjs
function nn(e, t) {
	return t ? e.replace("#version 300 es", "") : e;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/GlProgram.mjs
var rn = {
	stripVersion: nn,
	ensurePrecision: Zt,
	...
	setProgramName: tn,
	insertVersion: Qt
}, Y = /* @__PURE__ */ Object.create(null), an = class e {
	constructor(t) {
		t = {
			...e.defaultOptions,
			...t
		...
		Object.keys(rn).forEach((e) => {
			let t = r[e];
			i = rn[e](i, t, !0), a = rn[e](a, t, !1);
		}), this.fragment = i, this.vertex = a, this.transformFeedbackVaryings = t.transformFeedbackVaryings, this._key = Gt(`${this.vertex}:${this.fragment}`, "gl-program");
	}
	destroy() {
		this.fragment = null, this.vertex = null, this._attributeData = null, this._uniformData = null, this._uniformBlockData = null, this.transformFeedbackVaryings = null, Y[this._cacheKey] = null;
	}
	static from(t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/extractAttributesFromGpuProgram.mjs
var ln = {
	f32: "float32",
	"vec2<f32>": "float32x2",
	"vec3<f32>": "float32x3",
	...
	"vec3<bool>": "uint32x3",
	"vec4<bool>": "uint32x4"
}, un = /@location\((\d+)\)\s+([a-zA-Z0-9_]+)\s*:\s*([a-zA-Z0-9_<>]+)(?:,|\s|\)|$)/g;
function dn(e, t) {
	let n;
	for (; (n = un.exec(e)) !== null;) {
		let e = ln[n[3]] ?? "float32";
		t[n[2]] = {
...
function pn({ source: e, entryPoint: t }) {
	let n = {}, r = fn(e), i = r.indexOf(`fn ${t}(`);
	if (i === -1) return n;
	let a = r.indexOf("->", i);
	if (a === -1) return n;
	let o = r.substring(i, a);
	if (dn(o, n), Object.keys(n).length === 0) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/extractStructAndGroups.mjs
function mn(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/shader/const.mjs
var X = /* @__PURE__ */ ((e) => (e[e.VERTEX = 1] = "VERTEX", e[e.FRAGMENT = 2] = "FRAGMENT", e[e.COMPUTE = 4] = "COMPUTE", e))(X || {});
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/generateGpuLayoutGroups.mjs
function hn({ groups: e }) {
	let t = [];
	for (let n = 0; n < e.length; n++) {
		let r = e[n];
		t[r.group] || (t[r.group] = []), r.isUniform ? t[r.group].push({
			binding: r.binding,
			visibility: X.VERTEX | X.FRAGMENT,
			buffer: { type: "uniform" }
		}) : r.type === "sampler" ? t[r.group].push({
			binding: r.binding,
			visibility: X.FRAGMENT,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/generateLayoutHash.mjs
function gn({ groups: e }) {
	let t = [];
	for (let n = 0; n < e.length; n++) {
		let r = e[n];
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/removeStructAndGroupDuplicates.mjs
function _n(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/GpuProgram.mjs
var Z = /* @__PURE__ */ Object.create(null), vn = class e {
	constructor(e) {
		...
		if (this.name = a, this.fragment = t, this.vertex = n, t.source === n.source) {
			...
			let e = mn(n.source), r = mn(t.source);
			this.structsAndGroups = _n(e, r);
		}
		this.layout = r ?? gn(this.structsAndGroups), this.gpuLayout = i ?? hn(this.structsAndGroups), this.autoAssignGlobalUniforms = this.layout[0]?.globalUniforms !== void 0, this.autoAssignLocalUniforms = this.layout[1]?.localUniforms !== void 0, this._generateProgramKey();
	}
	_generateProgramKey() {
		let { vertex: e, fragment: t } = this, n = e.source + t.source + e.entryPoint + t.entryPoint;
		this._layoutKey = Gt(n, "program");
	}
	get attributeData() {
		return this._attributeData ??= pn(this.vertex), this._attributeData;
	}
	destroy() {
		this.gpuLayout = null, this.layout = null, this.structsAndGroups = null, this.fragment = null, this.vertex = null, Z[this._cacheKey] = null;
	}
	static from(t) {
		let n = `${t.vertex.source}:${t.fragment.source}:${t.fragment.entryPoint}:${t.vertex.entryPoint}`;
		return Z[n] || (Z[n] = new e(t), Z[n]._cacheKey = n), Z[n];
	}
}, yn = [
	"f32",
	"i32",
	...
	"vec3<i32>",
	"vec4<i32>"
], bn = yn.reduce((e, t) => (e[t] = !0, e), {});
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/shader/utils/getDefaultUniformValue.mjs
function xn(e, t) {
	switch (e) {
		case "f32": return 0;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/shader/UniformGroup.mjs
var Sn = class e {
	constructor(t, n) {
		this._touched = 0, this.uid = k("uniform"), this._resourceType = "uniformGroup", this._resourceId = k("resource"), this.isUniformGroup = !0, this._dirtyId = 0, this.destroyed = !1, n = {
			...e.defaultOptions,
			...n
		...
		for (let e in t) {
			let n = t[e];
			if (n.name = e, n.size = n.size ?? 1, !bn[n.type]) {
				let e = n.type.match(/^array<(\w+(?:<\w+>)?),\s*(\d+)>$/);
				if (e) {
					let [, t, r] = e;
					throw Error(`Uniform type ${n.type} is not supported. Use type: '${t}', size: ${r} instead.`);
				}
				throw Error(`Uniform type ${n.type} is not supported. Supported uniform types are: ${yn.join(", ")}`);
			}
			n.value ??= xn(n.type, n.size), r[e] = n.value;
		}
		this.uniforms = r, this._dirtyId = 1, this.ubo = n.ubo, this.isStatic = n.isStatic, this._signature = Gt(Object.keys(r).map((e) => `${e}-${t[e].type}`).join("-"), "uniform-group");
	}
	update() {
		this._dirtyId++;
	}
...
var Cn = Sn, wn = class {
...
}, Tn = /* @__PURE__ */ ((e) => (e[e.WEBGL = 1] = "WEBGL", e[e.WEBGPU = 2] = "WEBGPU", e[e.CANVAS = 4] = "CANVAS", e[e.BOTH = 3] = "BOTH", e))(Tn || {}), En = class e extends h {
	constructor(e) {
		super(), this.uid = k("shader"), this._uniformBindMap = /* @__PURE__ */ Object.create(null), this._ownedBindGroups = [], this._destroyed = !1;
		let { gpuProgram: t, glProgram: n, groups: r, resources: i, compatibleRenderers: a, groupMap: o } = e;
		this.gpuProgram = t, this.glProgram = n, a === void 0 && (a = 0, t && (a |= Tn.WEBGPU), n && (a |= Tn.WEBGL)), this.compatibleRenderers = a;
		let s = {};
		...
		if (!t && r && o) for (let e in o) for (let t in o[e]) {
			...
			let e = 0;
			for (let t in i) s[t] || (r[99] || (r[99] = new wn(), this._ownedBindGroups.push(r[99])), s[t] = {
				group: 99,
				binding: e,
				name: t
			...
			for (let e in i) {
				let t = e, n = i[e];
				!n.source && !n._resourceType && (n = new Cn(n));
				let a = s[t];
				a && (r[a.group] || (r[a.group] = new wn(), this._ownedBindGroups.push(r[a.group])), r[a.group].setResource(n, a.binding));
			}
		}
	...
	addResource(e, t, n) {
		var r, i;
		(r = this._uniformBindMap)[t] || (r[t] = {}), (i = this._uniformBindMap[t])[n] || (i[n] = e), this.groups[t] || (this.groups[t] = new wn(), this._ownedBindGroups.push(this.groups[t]));
	}
	...
	static from(t) {
		...
		return n && (a = vn.from(n)), r && (o = on.from(r)), new e({
			gpuProgram: a,
			glProgram: o,
			...i
		});
	...
	set blendMode(e) {
		this.blend = e !== "none", this._blendMode = e, this._blendModeId = Dn[e] || 0;
	}
	get polygonOffset() {
...
On.default2d = On.for2d();
var kn = On, An = class e extends En {
	constructor(t) {
		t = {
			...e.defaultOptions,
			...t
		}, super(t), this.enabled = !0, this._state = kn.for2d(), this.blendMode = t.blendMode, this.padding = t.padding, this.antialias = typeof t.antialias == "boolean" ? t.antialias ? "on" : "off" : t.antialias, this.resolution = t.resolution, this.blendRequired = t.blendRequired, this.clipToViewport = t.clipToViewport, this.addResource("uTexture", 0, 1), t.blendRequired && this.addResource("uBackTexture", 0, 3);
	}
	apply(e, t, n, r) {
...
var jn = An, Q = /* @__PURE__ */ ((e) => (e[e.MAP_READ = 1] = "MAP_READ", e[e.MAP_WRITE = 2] = "MAP_WRITE", e[e.COPY_SRC = 4] = "COPY_SRC", e[e.COPY_DST = 8] = "COPY_DST", e[e.INDEX = 16] = "INDEX", e[e.VERTEX = 32] = "VERTEX", e[e.UNIFORM = 64] = "UNIFORM", e[e.STORAGE = 128] = "STORAGE", e[e.INDIRECT = 256] = "INDIRECT", e[e.QUERY_RESOLVE = 512] = "QUERY_RESOLVE", e[e.STATIC = 1024] = "STATIC", e))(Q || {}), $ = class extends h {
	constructor(e) {
		let { data: t, size: n } = e, { usage: r, label: i, shrinkToFit: a } = e;
		super(), this._gpuData = /* @__PURE__ */ Object.create(null), this._gcLastUsed = -1, this.autoGarbageCollect = !0, this.uid = k("buffer"), this._resourceType = "buffer", this._resourceId = k("resource"), this._touched = 0, this._updateID = 1, this._dataInt32 = null, this.shrinkToFit = !0, this.destroyed = !1, t instanceof Array && (t = new Float32Array(t)), this._data = t, n ??= t?.byteLength;
		let o = !!t;
		this.descriptor = {
			size: n,
			usage: r,
	...
	setDataWithSize(e, t, n) {
		...
		if (this._data = e, this._dataInt32 = null, !r || r.length !== e.length) {
			!this.shrinkToFit && r && e.byteLength < r.byteLength ? n && this.emit("update", this) : (this.descriptor.size = e.byteLength, this._resourceId = k("resource"), this.emit("change", this));
			return;
		}
		n && this.emit("update", this);
	}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/ensureIsBuffer.mjs
function Mn(e, t) {
	if (!(e instanceof $)) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/getGeometryBounds.mjs
function Nn(e, t, n) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/Geometry.mjs
function Pn(e) {
	return (e instanceof $ || Array.isArray(e) || e.BYTES_PER_ELEMENT) && (e = { buffer: e }), e.buffer = Mn(e.buffer, !1), e;
}
var Fn = class extends h {
	constructor(e = {}) {
		super(), this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this.uid = k("geometry"), this._layoutKey = 0, this.instanceCount = 1, this._bounds = new F(), this._boundsDirty = !0;
	...
	addIndex(e) {
		this.indexBuffer = Mn(e, !0), this.buffers.push(this.indexBuffer);
	}
	get bounds() {
		return this._boundsDirty ? (this._boundsDirty = !1, Nn(this, "aPosition", this._bounds)) : this._bounds;
	}
	unload() {
		this.emit("unload", this);
		for (let e in this._gpuData) this._gpuData[e]?.destroy();
