import { B as e, C as t, M as n, b as r, p as i, v as a, w as o, x as s, z as c } from "./Geometry-BuU6bpP9.js";
import { a as l, c as u, d, g as f, h as p, m, o as h, r as g, u as _ } from "./Filter-N7Ki-nhd.js";
import { r as v } from "./canvasUtils-Cdp1yAfY.js";
import { n as y, t as b } from "./Cache-B-iCL9EE.js";
...
function C(e, t, n) {
	let r = p.get();
	e.measurable = !0;
	let i = f.get().identity(), a = w(e, n, i);
	d(e, r, a), e.measurable = !1, t.addBoundsMask(r), f.return(i), p.return(r);
}
function w(e, t, n) {
...
var A = class e extends o {
	...
	updateFrame() {
		if (!this.destroyed) {
			if (this._updateFPS) {
				let e = g.shared.elapsedMS * this.resource.playbackRate;
	...
	_configureAutoUpdate() {
		this._autoUpdate && this._isSourcePlaying() ? !this._updateFPS && this.resource.requestVideoFrameCallback ? (this._isConnectedToTicker && (g.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0), this._videoFrameRequestCallbackHandle === null && (this._videoFrameRequestCallbackHandle = this.resource.requestVideoFrameCallback(this._videoFrameRequestCallback))) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker || (g.shared.add(this.updateFrame, this), this._isConnectedToTicker = !0, this._msToNextUpdate = 0)) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker && (g.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0));
	}
	static test(e) {
...
s.from = F, o.from = N, e.add(T, E, D, j, v, l, t);
//#endregion
...
function te(e, t, n, r, i = !1) {
	...
	let o = _.getOptimalTexture(a.width, a.height, r, !1, i);
...
//# sourceMappingURL=getPo2TextureFromSource-CZ557Jpw.js.map
