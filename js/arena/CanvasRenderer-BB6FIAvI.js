...
function B(e, t, n = 2) {
	...
	R.size && R.clear();
	let a = ie(e, 0, i, n, !0), o = [];
	if (!a || a.next === a.prev) return o;
	let s = 0, c = 0, l = 0;
	if (r && (a = le(e, t, a, n)), e.length > 80 * n) {
		s = e[0], c = e[1];
		let t = s, r = c;
		for (let a = n; a < i; a += n) {
			let n = e[a], i = e[a + 1];
	...
	return ae(a, o, s, c, l), o;
}
function ie(e, t, n, r, i) {
	let a = null;
	if (i === Ue(e, t, n, r) > 0) for (let i = t; i < n; i += r) a = Be(i / r | 0, e[i], e[i + 1], a);
	else for (let i = n - r; i >= t; i -= r) a = Be(i / r | 0, e[i], e[i + 1], a);
	return a && Ne(a, a.next) && (Ve(a), a = a.next), a;
}
function V(e, t = e) {
	let n = t === e, r = e, i;
	do
		i = !1, r !== r.next && (R.size === 0 || !R.has(r)) && (Ne(r, r.next) || q(r.prev, r, r.next) === 0) ? ((n || r === t) && (t = r.prev), z = !0, Ve(r), r = r.prev, i = !0) : (n || r !== t) && (r = r.next, i = !n);
	while (i || r !== t);
	return t;
}
function ae(e, t, n, r, i) {
	...
	for (; e.prev !== e.next;) {
		...
		if (q(s, e, c) < 0 && (i ? se(e, n, r, i) : oe(e))) {
			t.push(s.i, e.i, c.i), Ve(e), e = c, a = c;
			continue;
		}
		if (e = c, e === a) {
			if (z = !1, e = V(e), z) {
...
function oe(e) {
	...
	for (; m !== t;) {
		if (m.x >= u && m.x <= f && m.y >= d && m.y <= p && (i !== m.x || s !== m.y) && je(i, s, a, c, o, l, m.x, m.y) && q(m.prev, m, m.next) >= 0) return !1;
		m = m.next;
	}
	return !0;
}
function se(e, t, n, r) {
	let i = e.prev, a = e, o = e.next, s = i.x, c = a.x, l = o.x, u = i.y, d = a.y, f = o.y, p = Math.min(s, c, l), m = Math.min(u, d, f), h = Math.max(s, c, l), g = Math.max(u, d, f), _ = ke(p, m, t, n, r), v = ke(h, g, t, n, r), y = e.prevZ;
	for (; y && y.z >= _;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== o && (s !== y.x || u !== y.y) && je(s, u, c, d, l, f, y.x, y.y) && q(y.prev, y, y.next) >= 0) return !1;
		y = y.prevZ;
	}
	let b = e.nextZ;
	for (; b && b.z <= v;) {
		if (b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== o && (s !== b.x || u !== b.y) && je(s, u, c, d, l, f, b.x, b.y) && q(b.prev, b, b.next) >= 0) return !1;
		b = b.nextZ;
	}
	return !0;
}
function ce(e, t) {
	...
	do {
		...
		Pe(i, n, n.next, a, !1) && Le(i, a) && Le(a, i) && (t.push(i.i, n.i, a.i), Ve(n), Ve(n.next), n = e = a, r = !0), n = n.next;
	} while (n !== e);
	return r ? V(n) : n;
}
function H(e, t, n, r, i) {
	...
	do {
		...
		for (; e !== a.prev;) {
			if (a.i !== e.i && Me(a, e)) {
				let o = ze(a, e);
				a = V(a, a.next), o = V(o, o.next), ae(a, t, n, r, i), ae(o, t, n, r, i);
				return;
			}
			e = e.next;
		}
...
function le(e, t, n, r) {
	...
	for (let n = 0, a = t.length; n < a; n++) {
		let o = ie(e, t[n] * r, n < a - 1 ? t[n + 1] * r : e.length, r, !1);
		o === o.next && R.add(o), i.push(Ae(o));
	}
	i.sort(ue), ge(e.length / r, t.length), _e(n, n), U = !0;
...
function de(e, t) {
	let n = xe(e, t);
	if (!n) return t;
	let r = ze(n, e), i = r.next;
	return _e(n, i.next), V(r, r.next), V(n, n.next);
}
var fe = 16, W = /* @__PURE__ */ new Float64Array(), pe = 0, me = [], he = [];
function ge(e, t) {
	let n = Math.ceil((e + 2 * t) / fe) + t + 2;
	W.length < n * 4 && (W = new Float64Array(n * 4)), pe = 0;
}
function _e(e, t) {
	let n = e;
	do {
		...
		he[e] = n;
		let c = e * 4;
		W[c] = r, W[c + 1] = i, W[c + 2] = a, W[c + 3] = o;
	} while (n !== t);
}
function ve(e, t) {
	let n = e.z * 4;
	t.x < W[n] && (W[n] = t.x), t.y < W[n + 1] && (W[n + 1] = t.y), t.x > W[n + 2] && (W[n + 2] = t.x), t.y > W[n + 3] && (W[n + 3] = t.y);
}
function ye(e) {
	let t = he[e];
...
function xe(e, t) {
	...
	if (Ne(e, n)) return n;
	for (let t = 0, s = 0; t < pe; t++, s += 4) {
		if (i < W[s + 1] || i > W[s + 3] || W[s] > r || W[s + 2] <= a) continue;
		let c = ye(t);
		n = be(t);
		do {
			if (n.prev.next === n) {
				if (Ne(e, n.next)) return n.next;
	...
	for (let t = 0, f = 0; t < pe; t++, f += 4) {
		if (W[f + 2] < s || W[f] > r || W[f + 3] < l || W[f + 1] > u) continue;
		let p = ye(t);
		n = be(t);
		do {
			if (n.prev.next === n && r >= n.x && n.x >= s && r !== n.x && je(i < c ? r : a, i, s, c, i < c ? a : r, i, n.x, n.y)) {
				let t = Math.abs(i - n.y) / (r - n.x);
				(Le(n, e) || n.y === i && n.next.y === i && n.next.x > r) && (t < d || t === d && (n.x > o.x || n.x === o.x && Se(o, n))) && (o = n, d = t);
			}
			n = n.next;
		} while (n !== p);
	}
...
var G = [], Ce = [], K = /* @__PURE__ */ new Uint32Array(), we = /* @__PURE__ */ new Uint32Array(), Te = /* @__PURE__ */ new Uint32Array(256);
function Ee(e, t, n, r) {
	let i = e, a = 0;
	do
		i.z = ke(i.x, i.y, t, n, r), G[a++] = i, i = i.next;
	while (i !== e);
	De(a);
	let o = null;
	for (let e = 0; e < a; e++) {
...
function De(e) {
	if (e <= 32) {
		for (let t = 1; t < e; t++) {
			let e = G[t], n = e.z, r = t - 1;
			for (; r >= 0 && G[r].z > n;) G[r + 1] = G[r], r--;
			G[r + 1] = e;
		}
		return;
	}
	K.length < e && (K = new Uint32Array(e), we = new Uint32Array(e), Ce = Array(e));
	for (let t = 0; t < e; t++) K[t] = G[t].z;
	Oe(e, G, K, Ce, we, 0), Oe(e, Ce, we, G, K, 8), Oe(e, G, K, Ce, we, 16), Oe(e, Ce, we, G, K, 24);
}
function Oe(e, t, n, r, i, a) {
	Te.fill(0);
	for (let t = 0; t < e; t++) Te[n[t] >>> a & 255]++;
	let o = 0;
	for (let e = 0; e < 256; e++) {
		let t = Te[e];
		Te[e] = o, o += t;
...
function Me(e, t) {
	let n = Ne(e, t) && q(e.prev, e, e.next) > 0 && q(t.prev, t, t.next) > 0;
	return e.next.i !== t.i && (n || Le(e, t) && Le(t, e) && (q(e.prev, e, t.prev) !== 0 || q(e, t.prev, t) !== 0)) && !Ie(e, t) && (n || Re(e, t));
}
function q(e, t, n) {
...
function Pe(e, t, n, r, i = !0) {
	...
	return (a > 0 && o < 0 || a < 0 && o > 0) && (s > 0 && c < 0 || s < 0 && c > 0) ? !0 : i ? !!(a === 0 && Fe(e, n, t) || o === 0 && Fe(e, r, t) || s === 0 && Fe(n, e, r) || c === 0 && Fe(n, t, r)) : !1;
}
function Fe(e, t, n) {
...
function Ie(e, t) {
	...
	do {
		...
		if (o.i !== e.i && s.i !== e.i && o.i !== t.i && s.i !== t.i && Pe(o, s, e, t)) return !0;
		o = s;
	} while (o !== e);
	return !1;
}
...
function ze(e, t) {
	let n = He(e.i, e.x, e.y), r = He(t.i, t.x, t.y), i = e.next, a = t.prev;
...
function Ve(e) {
	e.next.prev = e.prev, e.prev.next = e.next, e.prevZ && (e.prevZ.nextZ = e.nextZ), e.nextZ && (e.nextZ.prevZ = e.prevZ), U && ve(e.prev, e.next);
}
function He(e, t, n) {
	return {
		i: e,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/utils/utils.mjs
var We = B.default || B, Ge = {
	a: 7,
	c: 6,
	h: 1,
	l: 2,
	...
	v: 1,
	z: 0
}, Ke = /([astvzqmhlc])([^astvzqmhlc]*)/gi, qe = /-?[0-9]*\.?[0-9]+(?:e[-+]?\d+)?/gi;
function Je(e) {
	let t = [];
	return e.replace(Ke, (e, n, r) => {
		let i = n.toLowerCase(), a = n, o = Ye(r);
		for (i === "m" && o.length > 2 && (t.push([a, ...o.splice(0, 2)]), i = "l", a = a === "m" ? "l" : "L");;) {
			if (o.length === Ge[i]) return t.push([a, ...o]), "";
			if (o.length < Ge[i]) throw Error("malformed path data");
			t.push([a, ...o.splice(0, Ge[i])]);
		}
	}), t;
}
function Ye(e) {
	...
	for (let e = 0; e < n.length; e++) {
		...
		switch (l) {
			...
			case "v":
				...
				break;
			case "L":
				o = u[1], s = u[2], t.lineTo(o, s);
				break;
			case "l":
				o += u[1], s += u[2], t.lineTo(o, s);
				break;
			case "C":
				o = u[5], s = u[6], t.bezierCurveTo(u[1], u[2], u[3], u[4], o, s);
				break;
			case "c":
				t.bezierCurveTo(o + u[1], s + u[2], o + u[3], s + u[4], o + u[5], s + u[6]), o += u[5], s += u[6];
				break;
			case "S":
				o = u[3], s = u[4], t.bezierCurveToShort(u[1], u[2], o, s);
				break;
			case "s":
				t.bezierCurveToShort(o + u[1], s + u[2], o + u[3], s + u[4]), o += u[3], s += u[4];
				break;
			case "Q":
				o = u[3], s = u[4], t.quadraticCurveTo(u[1], u[2], o, s);
				break;
			case "q":
				t.quadraticCurveTo(o + u[1], s + u[2], o + u[3], s + u[4]), o += u[3], s += u[4];
				break;
			case "T":
				o = u[1], s = u[2], t.quadraticCurveToShort(o, s);
				break;
			case "t":
				o += u[1], s += u[2], t.quadraticCurveToShort(o, s);
				break;
			case "A":
				o = u[6], s = u[7], t.arcToSvg(u[1], u[2], u[3], u[4], u[5], o, s);
				break;
			case "a":
				o += u[6], s += u[7], t.arcToSvg(u[1], u[2], u[3], u[4], u[5], o, s);
				break;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/maths/shapes/Circle.mjs
var Ze = class e {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/maths/misc/squaredDistanceToLineSegment.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/maths/shapes/Polygon.mjs
var et, tt, nt = class e {
	constructor(...e) {
		this.type = "polygon";
	...
	containsPolygon(e) {
		let t = this.getBounds(et), n = e.getBounds(tt);
	...
	strokeContains(e, t, n, r = .5) {
		...
		for (let n = 0; n < c; n += 2) {
			...
			if ($e(e, t, r, i, c, l) <= (Math.sign((c - r) * (t - i) - (l - i) * (e - r)) < 0 ? o : a)) return !0;
		}
		return !1;
	}
	getBounds(e) {
	...
	strokeContains(e, t, n, r = .5) {
		...
		return (e >= i - l && e <= i + u || e >= h - u && e <= h + l) && t >= f && t <= f + m || (t >= a - l && t <= a + u || t >= g - u && t <= g + l) && e >= d && e <= d + p || e < d && t < f && rt(e, t, d, f, c, u, l) || e > h - c && t < f && rt(e, t, h - c, f, c, u, l) || e > h - c && t > g - c && rt(e, t, h - c, g - c, c, u, l) || e < d && t > g - c && rt(e, t, d, g - c, c, u, l);
	}
	toString() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/buildUvs.mjs
function at(e, t, n, r, i, a, o, s = null) {
	let c = 0;
	n *= t, i *= a;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/transformVertices.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/utils/getOrientationOfPoints.mjs
function ht(e) {
	let t = e.length;
	if (t < 6) return 1;
	let n = 0;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildLine.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/utils/triangulateWithHoles.mjs
...
function jt(e, t, n, r) {
	...
	return !(t.fill instanceof Y) && a.addressMode === "clamp-to-edge" && (a.addressMode = "repeat", a.update()), r && i.append(kt.copyFrom(r).invert()), i;
}
//#endregion
...
function Ft(e, t) {
	...
	for (let t = 0; t < e.instructions.length; t++) {
		...
		if (i.action === "texture") It(i.data, r, n);
		else if (i.action === "fill" || i.action === "stroke") {
			let e = i.action === "stroke", t = i.data.path.shapePath, a = i.data.style, o = i.data.hole;
			e && o && Lt(o.shapePath, a, !0, r, n), o && (t.shapePrimitives[t.shapePrimitives.length - 1].holes = o.shapePath.shapePrimitives), Lt(t, a, e, r, n);
		}
	}
}
function It(e, t, n) {
	let r = [], i = Mt.rectangle, a = Nt;
...
function Rt(e) {
	...
	for (let n = 0; n < e.length; n++) {
		let r = e[n].shape, i = [];
		Mt[r.type].build(r, i) && t.push(i);
	}
	return t;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/GraphicsContextSystem.mjs
var zt = class {
	constructor() {
...
function Kt(e, t, n, r, i, a, o, s, c, l) {
	let u = (Gt - Math.min(.99, Math.max(0, l ?? Ht.defaultOptions.bezierSmoothness))) / 1;
	return u *= u, qt(t, n, r, i, a, o, s, c, e, u), e;
}
function qt(e, t, n, r, i, a, o, s, c, l) {
	Jt(e, t, n, r, i, a, o, s, c, l, 0), c.push(o, s);
}
function Jt(e, t, n, r, i, a, o, s, c, l, u) {
	if (u > Ut) return;
	...
	Jt(e, t, d, f, _, v, x, S, c, l, u + 1), Jt(x, S, y, b, h, g, o, s, c, l, u + 1);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildAdaptiveQuadratic.mjs
var Yt = 8, Xt = 1.1920929e-7, Zt = 1;
function Qt(e, t, n, r, i, a, o, s) {
	let c = (Zt - Math.min(.99, Math.max(0, s ?? Ht.defaultOptions.bezierSmoothness))) / 1;
	return c *= c, $t(t, n, r, i, a, o, e, c), e;
}
function $t(e, t, n, r, i, a, o, s) {
	en(o, e, t, n, r, i, a, s, 0), o.push(i, a);
}
function en(e, t, n, r, i, a, o, s, c) {
	...
	en(e, t, n, l, u, p, m, s, c + 1), en(e, p, m, d, f, a, o, s, c + 1);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArc.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArcTo.mjs
function nn(e, t, n, r, i, a) {
	...
	tn(e, y + t, b + n, a, T, E, c * l > u * s);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArcToSvg.mjs
var rn = Math.PI * 2, an = {
	centerX: 0,
	centerY: 0,
	ang1: 0,
	ang2: 0
}, on = ({ x: e, y: t }, n, r, i, a, o, s, c) => {
	e *= n, t *= r;
...
}, ln = (e, t, n, r, i, a, o, s, c, l, u, d, f) => {
	let p = i ** 2, m = a ** 2, h = u ** 2, g = d ** 2, _ = p * m - p * g - m * h;
	_ < 0 && (_ = 0), _ /= p * g + m * h, _ = Math.sqrt(_) * (o === s ? -1 : 1);
	let v = _ * i / a * d, y = _ * -a / i * u, b = l * v - c * y + (e + n) / 2, x = c * v + l * y + (t + r) / 2, S = (u - v) / i, C = (d - y) / a, w = (-u - v) / i, T = (-d - y) / a, E = cn(1, 0, S, C), D = cn(S, C, w, T);
	s === 0 && D > 0 && (D -= rn), s === 1 && D < 0 && (D += rn), f.centerX = b, f.centerY = x, f.ang1 = E, f.ang2 = D;
};
function un(e, t, n, r, i, a, o, s = 0, c = 0, l = 0) {
	if (a === 0 || o === 0) return;
	let u = Math.sin(s * rn / 360), d = Math.cos(s * rn / 360), f = d * (t - r) / 2 + u * (n - i) / 2, p = -u * (t - r) / 2 + d * (n - i) / 2;
	if (f === 0 && p === 0) return;
	a = Math.abs(a), o = Math.abs(o);
	let m = f ** 2 / a ** 2 + p ** 2 / o ** 2;
	m > 1 && (a *= Math.sqrt(m), o *= Math.sqrt(m)), ln(t, n, r, i, a, o, c, l, u, d, f, p, an);
	let { ang1: h, ang2: g } = an, { centerX: _, centerY: v } = an, y = Math.abs(g) / (rn / 4);
	...
	for (let t = 0; t < b; t++) {
		let t = sn(h, g), { x: n, y: r } = on(t[0], a, o, d, u, _, v, C), { x: i, y: s } = on(t[1], a, o, d, u, _, v, C), { x: c, y: l } = on(t[2], a, o, d, u, _, v, C);
		Kt(e, x, S, n, r, i, s, c, l), x = c, S = l, h += g;
	}
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.19.0/node_modules/pixi.js/lib/scene/graphics/shared/path/roundShape.mjs
function dn(e, t, n) {
	let r = (e, t) => {
...
var pn = new p(), mn = class {
	...
	arc(e, t, n, r, i, a) {
		...
		return tn(o, e, t, n, r, i, a), this;
	}
	arcTo(e, t, n, r, i) {
		this._ensurePoly();
		let a = this._currentPoly.points;
		return nn(a, e, t, n, r, i), this;
	}
	arcToSvg(e, t, n, r, i, a, o) {
		let s = this._currentPoly.points;
		return un(s, this._currentPoly.lastX, this._currentPoly.lastY, a, o, e, t, n, r, i), this;
	}
	bezierCurveTo(e, t, n, r, i, a, o) {
		this._ensurePoly();
		let s = this._currentPoly;
		return Kt(this._currentPoly.points, s.lastX, s.lastY, e, t, n, r, i, a, o), this;
	}
	quadraticCurveTo(e, t, n, r, i) {
		this._ensurePoly();
		let a = this._currentPoly;
		return Qt(this._currentPoly.points, a.lastX, a.lastY, e, t, n, r, i), this;
	}
	closePath() {
	...
	roundShape(e, t, n = !1, r) {
		return e.length < 3 ? this : (n ? fn(this, e, t, r) : dn(this, e, t), this.closePath());
	}
	...
	ellipse(e, t, n, r, i) {
		return this.drawShape(new Qe(e, t, n, r), i), this;
	}
	roundRect(e, t, n, r, i, a) {
		return this.drawShape(new it(e, t, n, r, i), a), this;
	}
	drawShape(e, t) {
	...
	startPoly(e, t) {
		...
		return n && this.endPoly(), n = new nt(), n.points.push(e, t), this._currentPoly = n, this;
	}
	endPoly(e = !1) {
	...
	_ensurePoly(e = !0) {
		if (!this._currentPoly && (this._currentPoly = new nt(), e)) {
	...
	get bounds() {
		...
		for (let n = 0; n < t.length; n++) {
			let r = t[n], i = r.shape.getBounds(pn);
...
var Q = Kn, qn = class {
	...
	_initContextRenderData(e) {
		let t = new Jn(), n = this.getGpuContext(e);
...
function ar(e, t) {
	switch (t.type) {
		...
		case "roundedRectangle": {
			let n = t;
			ir(e, n.x, n.y, n.width, n.height, n.radius);
			break;
		}
		case "circle": {
			let n = t;
...
function or(e, t, n) {
	let r = [], i = [], a = [];
	if (!Mt[t.type]?.build(t, r)) return !1;
	_t(r, n, !1, t.closePath ?? !0, i, a);
...
function sr(e, t) {
	...
	for (let n = 0; n < t.length; n++) {
		...
		a && (e.save(), e.transform(i.a, i.b, i.c, i.d, i.tx, i.ty)), ar(e, r.shape), a && e.restore();
	}
	return !0;
}
var cr = class {
	...
	execute(e) {
		...
		for (let e = 0; e < o.length; e++) {
			...
			for (let e = 0; e < u.length; e++) {
				...
				a && (r.save(), r.transform(n.a, n.b, n.c, n.d, n.tx, n.ty)), l && i.style ? s = or(r, t.shape, i.style) || s : (ar(r, t.shape), c = sr(r, t.holes) || c, s = !0), a && r.restore();
			}
		}
		if (!s) {
...
var $ = "source-over";
function lr() {
	let e = E(), t = /* @__PURE__ */ Object.create(null);
...
function xr(e, t) {
	switch (t.type) {
		...
		case "roundedRectangle": {
			let n = t;
			br(e, n.x, n.y, n.width, n.height, n.radius);
			break;
		}
		case "circle": {
			let n = t;
...
function Sr(e, t) {
	...
	for (let n = 0; n < t.length; n++) {
		...
		if (!r?.shape) continue;
		let i = r.transform, a = i && !i.isIdentity();
		a && (e.save(), e.transform(i.a, i.b, i.c, i.d, i.tx, i.ty)), xr(e, r.shape), a && e.restore();
	}
	return !0;
}
function Cr(e, n, r, i) {
